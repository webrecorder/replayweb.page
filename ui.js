 ...
 * http://polymer.github.io/PATENTS.txt
 */
const v=new WeakMap,w=e=>(...t)=>{const i=e(...t);return v.set(i,!0),i},x=e=>"function"==typeof e&&v.has(e),k={},y={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const z=` ${n} `;class ${constructor(e,t,i,a){this.strings=e,this.values=t,this.type=i,this.processor=a}getHTML(){const e=this.strings.length-1;let t="",i=!1;for(let a=0;a<e;a++){const e=this.strings[a],r=e.lastIndexOf("\x3c!--");i=(r>-1||i)&&-1===e.indexOf("--\x3e",r+1);const o=b.exec(e);t+=null===o?e+(i?z:s):e.substr(0,o.index)+o[1]+o[2]+"$lit$"+o[3]+n}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const _=e=>null===e||!("object"==typeof e||"function"==typeof e),C=e=>Array.isArray(e)||!(!e||!e[Symbol.iterator]);class P{constructor(e,t,i){this.dirty=!0,this.element=e,this.name=t,this.strings=i,this.parts=[];for(let e=0;e<i.length-1;e++)this.parts[e]=this._createPart()}_createPart(){return new L(this)}_getValue(){const e=this.strings,t=e.length-1;let i="";for(let a=0;a<t;a++){i+=e[a];const t=this.parts[a];if(void 0!==t){const e=t.value;if(_(e)||!C(e))i+="string"==typeof e?e:String(e);else for(const t of e)i+="string"==typeof t?t:String(t)}}return i+=e[t],i}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class L{constructor(e){this.value=void 0,this.committer=e}setValue(e){e===k||_(e)&&e===this.value||(this.value=e,x(e)||(this.committer.dirty=!0))}commit(){for(;x(this.value);){const e=this.value;this.value=k,e(this)}this.value!==k&&this.committer.commit()}}class T{constructor(e){this.value=void 0,this.__pendingValue=void 0,this.options=e}appendInto(e){this.startNode=e.appendChild(f()),this.endNode=e.appendChild(f())}insertAfterNode(e){this.startNode=e,this.endNode=e.nextSibling}appendIntoPart(e){e.__insert(this.startNode=f()),e.__insert(this.endNode=f())}insertAfterPart(e){e.__insert(this.startNode=f()),this.endNode=e.endNode,e.endNode=this.startNode}setValue(e){this.__pendingValue=e}commit(){if(null===this.startNode.parentNode)return;for(;x(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=k,e(this)}const e=this.__pendingValue;e!==k&&(_(e)?e!==this.value&&this.__commitText(e):e instanceof $?this.__commitTemplateResult(e):e instanceof Node?this.__commitNode(e):C(e)?this.__commitIterable(e):e===y?(this.value=y,this.clear()):this.__commitText(e))}__insert(e){this.endNode.parentNode.insertBefore(e,this.endNode)}__commitNode(e){this.value!==e&&(this.clear(),this.__insert(e),this.value=e)}__commitText(e){const t=this.startNode.nextSibling,i="string"==typeof(e=null==e?"":e)?e:String(e);t===this.endNode.previousSibling&&3===t.nodeType?t.data=i:this.__commitNode(document.createTextNode(i)),this.value=e}__commitTemplateResult(e){const t=this.options.templateFactory(e);if(this.value instanceof S&&this.value.template===t)this.value.update(e.values);else{const i=new S(t,e.processor,this.options),a=i._clone();i.update(e.values),this.__commitNode(a),this.value=i}}__commitIterable(e){Array.isArray(this.value)||(this.value=[],this.clear());const t=this.value;let i,a=0;for(const r of e)i=t[a],void 0===i&&(i=new T(this.options),t.push(i),0===a?i.appendIntoPart(this):i.insertAfterPart(t[a-1])),i.setValue(r),i.commit(),a++;a<t.length&&(t.length=a,this.clear(i&&i.endNode))}clear(e=this.startNode){o(this.startNode.parentNode,e.nextSibling,this.endNode)}}class D{constructor(e,t,i){if(this.value=void 0,this.__pendingValue=void 0,2!==i.length||""!==i[0]||""!==i[1])throw new Error("Boolean attributes can only contain a single expression");this.element=e,this.name=t,this.strings=i}setValue(e){this.__pendingValue=e}commit(){for(;x(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=k,e(this)}if(this.__pendingValue===k)return;const e=!!this.__pendingValue;this.value!==e&&(e?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=e),this.__pendingValue=k}}class E extends P{constructor(e,t,i){super(e,t,i),this.single=2===i.length&&""===i[0]&&""===i[1]}_createPart(){return new A(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class A extends L{}let I=!1;(()=>{try{const e={get capture(){return I=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}})();class R{constructor(e,t,i){this.value=void 0,this.__pendingValue=void 0,this.element=e,this.eventName=t,this.eventContext=i,this.__boundHandleEvent=e=>this.handleEvent(e)}setValue(e){this.__pendingValue=e}commit(){for(;x(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=k,e(this)}if(this.__pendingValue===k)return;const e=this.__pendingValue,t=this.value,i=null==e||null!=t&&(e.capture!==t.capture||e.once!==t.once||e.passive!==t.passive),a=null!=e&&(null==t||i);i&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),a&&(this.__options=U(e),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=e,this.__pendingValue=k}handleEvent(e){"function"==typeof this.value?this.value.call(this.eventContext||this.element,e):this.value.handleEvent(e)}}const U=e=>e&&(I?{capture:e.capture,passive:e.passive,once:e.once}:e.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,a){const r=t[0];if("."===r){return new E(e,t.slice(1),i).parts}return"@"===r?[new R(e,t.slice(1),a.eventContext)]:"?"===r?[new D(e,t.slice(1),i)]:new P(e,t,i).parts}handleTextExpression(e){return new T(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const O=(e,...t)=>new $(e,t,"html",N),B=(e,t)=>`${e}--${t}`;let G=!0;void 0===window.ShadyCSS?G=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),G=!1);const H=e=>t=>{const i=B(t.type,e);let a=q.get(i);void 0===a&&(a={stringsArray:new WeakMap,keyString:new Map},q.set(i,a));let r=a.stringsArray.get(t.strings);if(void 0!==r)return r;const o=t.strings.join(n);if(r=a.keyString.get(o),void 0===r){const i=t.getTemplateElement();G&&window.ShadyCSS.prepareTemplateDom(i,e),r=new c(t,i),a.keyString.set(o,r)}return a.stringsArray.set(t.strings,r),r},F=["html","svg"],W=new Set,V=(e,t,i)=>{W.add(e);const a=i?i.element:document.createElement("template"),r=t.querySelectorAll("style"),{length:o}=r;if(0===o)return void window.ShadyCSS.prepareTemplateStyles(a,e);const n=document.createElement("style");for(let e=0;e<o;e++){const t=r[e];t.parentNode.removeChild(t),n.textContent+=t.textContent}(e=>{F.forEach(t=>{const i=q.get(B(t,e));void 0!==i&&i.keyString.forEach(e=>{const{element:{content:t}}=e,i=new Set;Array.from(t.querySelectorAll("style")).forEach(e=>{i.add(e)}),u(e,i)})})})(e);const s=a.content;i?function(e,t,i=null){const{element:{content:a},parts:r}=e;if(null==i)return void a.appendChild(t);const o=document.createTreeWalker(a,133,null,!1);let n=g(r),s=0,l=-1;for(;o.nextNode();){for(l++,o.currentNode===i&&(s=m(t),i.parentNode.insertBefore(t,i));-1!==n&&r[n].index===l;){if(s>0){for(;-1!==n;)r[n].index+=s,n=g(r,n);return}n=g(r,n)}}}(i,n,s.firstChild):s.insertBefore(n,s.firstChild),window.ShadyCSS.prepareTemplateStyles(a,e);const l=s.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==l)t.insertBefore(l.cloneNode(!0),t.firstChild);else if(i){s.insertBefore(n,s.firstChild);const e=new Set;e.add(n),u(i,e)}};window.JSCompiler_renameProperty=(e,t)=>e;const K={toAttribute(e,t){switch(t){case Boolean:return e?"":null;case Object:case Array:return null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){switch(t){case Boolean:return null!==e;case Number:return null===e?null:Number(e);case Object:case Array:return JSON.parse(e)}return e}},Z=(e,t)=>t!==e&&(t==t||e==e),Y={attribute:!0,type:String,converter:K,reflect:!1,hasChanged:Z};class J extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=new Promise(e=>this._enableUpdatingResolver=e),this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const e=[];return this._classProperties.forEach((t,i)=>{const a=this._attributeNameForProperty(i,t);void 0!==a&&(this._attributeToPropertyMap.set(a,i),e.push(a))}),e}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const e=Object.getPrototypeOf(this)._classProperties;void 0!==e&&e.forEach((e,t)=>this._classProperties.set(t,e))}}static createProperty(e,t=Y){if(this._ensureClassProperties(),this._classProperties.set(e,t),t.noAccessor||this.prototype.hasOwnProperty(e))return;const i="symbol"==typeof e?Symbol():"__"+e,a=this.getPropertyDescriptor(e,i,t);void 0!==a&&Object.defineProperty(this.prototype,e,a)}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(i){const a=this[e];this[t]=i,this._requestUpdate(e,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this._classProperties&&this._classProperties.get(e)||Y}static finalize(){const e=Object.getPrototypeOf(this);if(e.hasOwnProperty("finalized")||e.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const e=this.properties,t=[...Object.getOwnPropertyNames(e),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(e):[]];for(const i of t)this.createProperty(i,e[i])}}static _attributeNameForProperty(e,t){const i=t.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof e?e.toLowerCase():void 0}static _valueHasChanged(e,t,i=Z){return i(e,t)}static _propertyValueFromAttribute(e,t){const i=t.type,a=t.converter||K,r="function"==typeof a?a:a.fromAttribute;return r?r(e,i):e}static _propertyValueToAttribute(e,t){if(void 0===t.reflect)return;const i=t.type,a=t.converter;return(a&&a.toAttribute||K.toAttribute)(e,i)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((e,t)=>{if(this.hasOwnProperty(t)){const e=this[t];delete this[t],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(t,e)}})}_applyInstanceProperties(){this._instanceProperties.forEach((e,t)=>this[t]=e),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(e,t,i){t!==i&&this._attributeToProperty(e,i)}_propertyToAttribute(e,t,i=Y){const a=this.constructor,r=a._attributeNameForProperty(e,i);if(void 0!==r){const e=a._propertyValueToAttribute(t,i);if(void 0===e)return;this._updateState=8|this._updateState,null==e?this.removeAttribute(r):this.setAttribute(r,e),this._updateState=-9&this._updateState}}_attributeToProperty(e,t){if(8&this._updateState)return;const i=this.constructor,a=i._attributeToPropertyMap.get(e);if(void 0!==a){const e=i.getPropertyOptions(a);this._updateState=16|this._updateState,this[a]=i._propertyValueFromAttribute(t,e),this._updateState=-17&this._updateState}}_requestUpdate(e,t){let i=!0;if(void 0!==e){const a=this.constructor,r=a.getPropertyOptions(e);a._valueHasChanged(this[e],t,r.hasChanged)?(this._changedProperties.has(e)||this._changedProperties.set(e,t),!0!==r.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(e,r))):i=!1}!this._hasRequestedUpdate&&i&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(e,t){return this._requestUpdate(e,t),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(e){}const e=this.performUpdate();return null!=e&&await e,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let e=!1;const t=this._changedProperties;try{e=this.shouldUpdate(t),e?this.update(t):this._markUpdated()}catch(t){throw e=!1,this._markUpdated(),t}e&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(t)),this.updated(t))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(e){return!0}update(e){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((e,t)=>this._propertyToAttribute(t,this[t],e)),this._reflectingProperties=void 0),this._markUpdated()}updated(e){}firstUpdated(e){}}J.finalized=!0;
/**
@license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const oe=new WeakMap,ne=w(e=>t=>{if(!(t instanceof T))throw new Error("unsafeSVG can only be used in text bindings");const i=oe.get(t);if(void 0!==i&&_(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=`<svg>${e}</svg>`;const o=a.content,n=o.firstChild;o.removeChild(n),r(o,n.firstChild);const s=document.importNode(o,!0);t.setValue(s),oe.set(t,{value:e,fragment:s})}),se=new WeakMap,le=w(e=>t=>{if(!(t instanceof L)||t instanceof A||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=t,{style:a}=i.element;let r=se.get(t);void 0===r&&(a.cssText=i.strings.join(" "),se.set(t,r=new Set)),r.forEach(t=>{t in e||(r.delete(t),-1===t.indexOf("-")?a[t]=null:a.removeProperty(t))});for(const t in e)r.add(t),-1===t.indexOf("-")?a[t]=e[t]:a.setProperty(t,e[t])});var ce=i(90),de=i.n(ce),he=i(53),fe=i.n(he);const be=te(de.a);function ue(e){return[be,e]}const me=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches;class pe extends re{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return ie`
    :host {
    ...
    `}render(){if(!this.svg)return O``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),O`<svg style="${le(e)}"><g>${ne(this.svg)}</g></svg>`}}customElements.define("fa-icon",pe),customElements.define("wr-anim-logo",class extends pe{constructor(){super(),this.svg=fe.a}static get styles(){return ie`
    #wrlogo #stop5687 {
    ...
    `}});var ge;function ve(e,t){void 0===t&&(t={});var i=t.registrationOptions;void 0===i&&(i={}),delete t.registrationOptions;var a=function(e){for(var i=[],a=arguments.length-1;a-- >0;)i[a]=arguments[a+1];t&&t[e]&&t[e].apply(t,i)};"serviceWorker"in navigator&&ge.then((function(){Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/))?(!function(e,t,i){fetch(e).then((function(a){404===a.status?(t("error",new Error("Service worker not found at "+e)),ke()):-1===a.headers.get("content-type").indexOf("javascript")?(t("error",new Error("Expected "+e+" to have javascript content-type, but received "+a.headers.get("content-type"))),ke()):xe(e,t,i)})).catch((function(e){return we(t,e)}))}(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)}))):(xe(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})))}))}function we(e,t){navigator.onLine||e("offline"),e("error",t)}function xe(e,t,i){navigator.serviceWorker.register(e,i).then((function(e){t("registered",e),e.waiting?t("updated",e):e.onupdatefound=function(){t("updatefound",e);var i=e.installing;i.onstatechange=function(){"installed"===i.state&&(navigator.serviceWorker.controller?t("updated",e):t("cached",e))}}})).catch((function(e){return we(t,e)}))}function ke(){"serviceWorker"in navigator&&navigator.serviceWorker.ready.then((function(e){e.unregister()}))}async function ye(e="sw.js",t="./"){let i,a;const r=new Promise((e,t)=>{i=e,a=t});navigator.serviceWorker||(console.error("Service Workers not supported"),a()),ve(t+e,{registrationOptions:{scope:t},registered(e){console.log("Service worker is registered"),i()},error(e){console.error("Error during service worker registration:",e),a()}}),await r}"undefined"!=typeof window&&(ge="undefined"!=typeof Promise?new Promise((function(e){return window.addEventListener("load",e)})):{then:function(e){return window.addEventListener("load",e)}});let Se=null;function ze(){return null===Se&&(Se=new Worker("sw.js")),Se}function $e(e){let t=null;try{t=new Date(e.ts||e.date)}catch(e){}const i=t&&!isNaN(t)?_e(t.toISOString()):"";return{date:t,timestamp:i}}function _e(e){return e.replace(/[-:T]/g,"").slice(0,14)}async function Ce(e){return{url:e,coll:"id-"+(await async function(e,t){const i=(new TextEncoder).encode(e),a=await crypto.subtle.digest(t,i);return Array.from(new Uint8Array(a)).map(e=>e.toString(16).padStart(2,"0")).join("")}(e,"SHA-256")).slice(0,12)}}var Pe=i(8),Le=i.n(Pe),Te=i(91),De=i.n(Te),Ee=i(29),Ae=i.n(Ee),Ie=i(30),Re=i.n(Ie),Ue=i(92),je=i.n(Ue);customElements.define("replay-app-main",class extends re{constructor(){super(),this.sourceUrl=null,this.collInfo=null,this.showTerms=!1,this.pageParams={},this.inited=!1,ye("sw.js"),ze(),this.safariKeyframes()}static get properties(){return{inited:{type:Boolean},pageParams:{type:Object},sourceUrl:{type:String},navMenuShown:{type:Boolean},showTerms:{type:Boolean},collInfo:{type:Object},loadInfo:{type:Object},embed:{type:String}}}static get styles(){return ue(ie`
    #wrlogo {
      max-height: 2.5rem;
    }
    .wr-logo-item {
    ...
    `)}render(){return this.inited?O`
    ${this.embed&&"full"!==this.embed?"":O`
      <nav class="navbar has-background-info" role="navigation" aria-label="main navigation">
      <div class="navbar-brand">
        ${this.embed?O`
        <a class="navbar-item wr-logo-item" title="ReplayWeb.page">
          <fa-icon id="wrlogo" size="2.5rem" .svg=${fe.a}></fa-icon>
        </a>
        `:O`
      ...
      ${me&&!this.collInfo?O`
        <a class="navbar-item arrow-button" title="Go Back" @click="${e=>window.history.back()}">
          <fa-icon .svg="${Ae.a}"></fa-icon><span class="menu-only">&nbsp;Go Back</span>
        </a>
        <a class="navbar-item arrow-button" title="Go Forward" @click="${e=>window.history.forward()}">
          <fa-icon .svg="${Re.a}"></fa-icon><span class="menu-only">&nbsp;Go Forward</span>
        </a>
      `:""}
      ${this.sourceUrl&&this.collInfo?O`
        <div class="navbar-item has-dropdown is-hoverable">
          <a class="info-menu navbar-link is-arrowless"><fa-icon size="1.2em" .svg="${je.a}"></fa-icon>
          ...
          <div class="navbar-dropdown">
            ...
            <div class="navbar-item">
              Total Size:&nbsp;<b>${Le()(Number(this.collInfo.size||0))}</b>
            </div>
            <div class="navbar-item">
            ...
            <hr class="navbar-divider">
            <div class="navbar-item">
              ReplayWeb.page Version: ${"1.1.0-beta.2"}
            </div>
          </div>
        </div>
        `:""}
      ...
      ${this.embed?O``:O`
        <div class="navbar-end">
          <a href="/docs" target="_blank" class="navbar-item">
            <fa-icon .svg="${De.a}"></fa-icon><span>&nbsp;User Docs</span>
          </a>
  ...
  <div class="modal is-active">
    <div class="modal-background" @click="${e=>this.showTerms=!1}"></div>
      <div class="modal-card">
        <header class="modal-card-head">
        <p class="modal-card-title">Terms and Privacy</p>
          <button class="delete" aria-label="close" @click="${e=>this.showTerms=!1}"></button>
        </header>
        <section class="modal-card-body">
          <div class="container">
            ...
            <a class="button is-warning" href="#" @click="${e=>this.showTerms=!1}">Close</a>
            </div>
          </div>
        </section>
      </div>
  </div>
  `:""} `:O``}firstUpdated(){this.initRoute(),window.addEventListener("popstate",e=>{this.initRoute()})}updated(e){e.has("sourceUrl")&&(this.collInfo=null)}onFavIcons(e){const t=document.querySelector("head"),i=document.querySelectorAll("link[rel*='icon']");for(const e of i)t.removeChild(e);for(const i of e.detail.icons){const e=document.createElement("link");e.rel=i.rel,e.href=i.href,t.appendChild(e)}}onNavMenu(e){e.stopPropagation(),this.navMenuShown=!this.navMenuShown,this.navMenuShown&&document.addEventListener("click",()=>{this.navMenuShown=!1},{once:!0})}initRoute(){this.inited=!0,this.pageParams=new URLSearchParams(window.location.search);let e=this.pageParams.get("state");if(e)try{if(e=JSON.parse(e),e.ids instanceof Array&&e.userId&&"open"===e.action)return this.pageParams.set("source","googledrive://"+e.ids[0]),this.pageParams.delete("state"),void(window.location.search=this.pageParams.toString())}catch(e){console.log(e)}if(this.sourceUrl=this.pageParams.get("source")||"",this.embed=this.pageParams.get("embed")||"",this.pageParams.has("terms")&&(this.showTerms=!0),this.pageParams.get("config")){this.loadInfo||(this.loadInfo={});try{this.loadInfo.extraConfig=JSON.parse(this.pageParams.get("config"))}catch(e){console.log("invalid config: "+e)}}this.pageParams.get("basePageUrl")&&(this.loadInfo||(this.loadInfo={extraConfig:{}}),this.loadInfo.extraConfig||(this.loadInfo.extraConfig={}),this.loadInfo.extraConfig.baseUrl=this.pageParams.get("basePageUrl")),this.pageParams.get("customColl")&&(this.loadInfo||(this.loadInfo={}),this.loadInfo.customColl=this.pageParams.get("customColl"))}onStartLoad(e){if(this.pageParams.set("source",e.detail.sourceUrl),e.detail.isFile){{const e=new URL(window.location.href);e.search=this.pageParams.toString(),window.history.pushState({},"",e.toString())}this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail}else window.location.search=this.pageParams.toString()}onCollLoaded(e){this.loadInfo=null,e.detail.collInfo&&(this.collInfo=e.detail.collInfo),e.detail.alreadyLoaded||e.detail.sourceUrl!==this.sourceUrl&&(this.pageParams.set("source",e.detail.sourceUrl),window.location.search=this.pageParams.toString())}safariKeyframes(){const e=document.createElement("style");document.head.appendChild(e),e.appendChild(document.createTextNode("\n    @keyframes spinAround {\n      from {\n        transform: rotate(0deg);\n      }\n      to {\n        transform: rotate(359deg);\n      }\n    }\n    "))}});var qe=i(93),Me=i.n(qe);customElements.define("wr-chooser",class extends re{constructor(){super(),this.fileDisplayName="",this.file=null}onChooseFile(e){0!==e.currentTarget.files.length&&(this.file=e.currentTarget.files[0],this.fileDisplayName="file://"+(this.file.path||this.file.name),this.requestUpdate())}onStartLoad(e){e.preventDefault();const t={sourceUrl:this.fileDisplayName};if(this.file){if(t.isFile=!0,this.file.path){const e=new URL("http://files.replayweb.page/");e.searchParams.set("filename",this.file.path),t.loadUrl=e.href}else t.loadUrl=URL.createObjectURL(this.file),t.blob=this.file;t.size=this.file.size,t.noCache=void 0!==this.file.path,t.name=this.fileDisplayName}return this.dispatchEvent(new CustomEvent("load-start",{detail:t})),!1}onInput(e){this.fileDisplayName=e.currentTarget.value,this.file&&this.fileDisplayName&&this.fileDisplayName.startsWith("file://")&&(this.file=null,this.fileDisplayName="")}static get styles(){return ue(ie`
    :host {
      min-width: 0;
    }
    .extra-padding {
  ...
  `)}render(){return O`
            ...
            <label class="file-label">
              ...
              <span class="file-cta">
                <span class="file-icon">
                  <fa-icon size="0.9em" .svg=${Me.a}></fa-icon>
                </span>
    ...
    <section class="section no-top-padding">
      <div class="sort-header is-small">
        <a @click=${e=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?Fe.a:Ge.a}></span>
      ...
      <nav class="panel is-light">
        ...
        <div class="coll-list">
          ${this.sortedColls.map((e,t)=>O`
            <div class="coll-block panel-block">
              <div class="columns">
                <div class="column col-title is-4">
                  <span class="subtitle has-text-weight-bold">
                    <a href="?source=${e.sourceUrl}">${e.title||e.filename}</a>
                  </span>
                </div>
                ...
                <div class="column is-2"><p class="minihead">Total Size</p>${Le()(Number(e.size||0))}
                 
                </div>
              </div>
              ${this._deleting[e.sourceUrl]?O`
              <button class="button delete is-loading is-static"></button>`:O`
              <button class="delete" title="Unload Collection" data-coll-index="${t}" @click="${this.onDeleteColl}"></button>
              `}
            </div>
          `)}
        </div>
    ...
    `}onCopy(e,t){return e.preventDefault(),e.stopPropagation(),navigator.clipboard.writeText(t),!1}}customElements.define("wr-coll-index",Ke);var Ze=i(97),Ye=i.n(Ze),Je=i(58),Qe=i.n(Je),Xe=i(98),et=i.n(Xe),tt=i(99),it=i.n(tt),at=i(59),rt=i.n(at),ot=i(60),nt=i.n(ot),st=i(61),lt=i.n(st),ct=i(100),dt=i.n(ct),ht=i(101),ft=i.n(ht),bt=i(102),ut=i.n(bt),mt="undefined"!=typeof window?window:null,pt=null===mt,gt=pt?void 0:mt.document,vt=function(){return!1},wt=pt?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=gt.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",xt=function(e){return"string"==typeof e||e instanceof String},kt=function(e){if(xt(e)){var t=gt.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},yt=function(e,t,i){var a=e[t];return void 0!==a?a:i},St=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},zt=function(e,t){var i=gt.createElement("div");return i.className="gutter gutter-"+t,i},$t=function(e,t,i){var a={};return xt(t)?a[e]=t:a[e]=wt+"("+t+"% - "+i+"px)",a},_t=function(e,t){var i;return(i={})[e]=t+"px",i},Ct=function(e,t){if(void 0===t&&(t={}),pt)return{};var i,a,r,o,n,s,l=e;Array.from&&(l=Array.from(l));var c=kt(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,h=d?d.flexDirection:null,f=yt(t,"sizes")||l.map((function(){return 100/l.length})),b=yt(t,"minSize",100),u=Array.isArray(b)?b:l.map((function(){return b})),m=yt(t,"expandToMin",!1),p=yt(t,"gutterSize",10),g=yt(t,"gutterAlign","center"),v=yt(t,"snapOffset",30),w=yt(t,"dragInterval",1),x=yt(t,"direction","horizontal"),k=yt(t,"cursor","horizontal"===x?"col-resize":"row-resize"),y=yt(t,"gutter",zt),S=yt(t,"elementStyle",$t),z=yt(t,"gutterStyle",_t);function $(e,t,a,r){var o=S(i,t,a,r);Object.keys(o).forEach((function(t){e.style[t]=o[t]}))}function _(){return s.map((function(e){return e.size}))}function C(e){return"touches"in e?e.touches[0][a]:e[a]}function P(e){var t=s[this.a],i=s[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,$(t.element,t.size,this._b,t.i),$(i.element,i.size,this._c,i.i)}function L(e){var i,a=s[this.a],r=s[this.b];this.dragging&&(i=C(e)-this.start+(this._b-this.dragOffset),w>1&&(i=Math.round(i/w)*w),i<=a.minSize+v+this._b?i=a.minSize+this._b:i>=this.size-(r.minSize+v+this._c)&&(i=this.size-(r.minSize+this._c)),P.call(this,i),yt(t,"onDrag",vt)(_()))}function T(){var e=s[this.a].element,t=s[this.b].element,a=e.getBoundingClientRect(),n=t.getBoundingClientRect();this.size=a[i]+n[i]+this._b+this._c,this.start=a[r],this.end=a[o]}function D(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[n];return 0===i?null:i-="horizontal"===x?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(u.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,o){var n=t*r/100,s=St(p,0===o,o===e.length-1,g),l=u[o]+s;return n<l?(i+=l-n,a.push(0),l):(a.push(n-l),n)}));return 0===i?e:r.map((function(e,r){var o=e;if(i>0&&a[r]-i>0){var n=Math.min(i,a[r]-i);i-=n,o=e-n}return o/t*100}))}function E(){var e=s[this.a].element,i=s[this.b].element;this.dragging&&yt(t,"onDragEnd",vt)(_()),this.dragging=!1,mt.removeEventListener("mouseup",this.stop),mt.removeEventListener("touchend",this.stop),mt.removeEventListener("touchcancel",this.stop),mt.removeEventListener("mousemove",this.move),mt.removeEventListener("touchmove",this.move),this.stop=null,this.move=null,e.removeEventListener("selectstart",vt),e.removeEventListener("dragstart",vt),i.removeEventListener("selectstart",vt),i.removeEventListener("dragstart",vt),e.style.userSelect="",e.style.webkitUserSelect="",e.style.MozUserSelect="",e.style.pointerEvents="",i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",this.gutter.style.cursor="",this.parent.style.cursor="",gt.body.style.cursor=""}function A(e){if(!("button"in e)||0===e.button){var i=s[this.a].element,a=s[this.b].element;this.dragging||yt(t,"onDragStart",vt)(_()),e.preventDefault(),this.dragging=!0,this.move=L.bind(this),this.stop=E.bind(this),mt.addEventListener("mouseup",this.stop),mt.addEventListener("touchend",this.stop),mt.addEventListener("touchcancel",this.stop),mt.addEventListener("mousemove",this.move),mt.addEventListener("touchmove",this.move),i.addEventListener("selectstart",vt),i.addEventListener("dragstart",vt),a.addEventListener("selectstart",vt),a.addEventListener("dragstart",vt),i.style.userSelect="none",i.style.webkitUserSelect="none",i.style.MozUserSelect="none",i.style.pointerEvents="none",a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",this.gutter.style.cursor=k,this.parent.style.cursor=k,gt.body.style.cursor=k,T.call(this),this.dragOffset=C(e)-this.end}}"horizontal"===x?(i="width",a="clientX",r="left",o="right",n="clientWidth"):"vertical"===x&&(i="height",a="clientY",r="top",o="bottom",n="clientHeight"),f=D(f);var I=[];function R(e){var t=e.i===I.length,i=t?I[e.i-1]:I[e.i];T.call(i);var a=t?i.size-e.minSize-i._c:e.minSize+i._b;P.call(i,a)}return(s=l.map((function(e,t){var a,r={element:kt(e),size:f[t],minSize:u[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:x,parent:c})._b=St(p,t-1==0,!1,g),a._c=St(p,!1,t===l.length-1,g),"row-reverse"===h||"column-reverse"===h)){var o=a.a;a.a=a.b,a.b=o}if(t>0){var n=y(t,x,r.element);!function(e,t,a){var r=z(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(n,p,t),a._a=A.bind(a),n.addEventListener("mousedown",a._a),n.addEventListener("touchstart",a._a),c.insertBefore(n,r.element),a.gutter=n}return $(r.element,r.size,St(p,0===t,t===l.length-1,g),t),t>0&&I.push(a),r}))).forEach((function(e){var t=e.element.getBoundingClientRect()[i];t<e.minSize&&(m?R(e):e.minSize=t)})),{setSizes:function(e){var t=D(e);t.forEach((function(e,i){if(i>0){var a=I[i-1],r=s[a.a],o=s[a.b];r.size=t[i-1],o.size=e,$(r.element,r.size,a._b,r.i),$(o.element,o.size,a._c,o.i)}}))},getSizes:_,collapse:function(e){R(s[e])},destroy:function(e,t){I.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter.removeEventListener("mousedown",a._a),a.gutter.removeEventListener("touchstart",a._a)),!0!==e){var r=S(i,a.a.size,a._b);Object.keys(r).forEach((function(e){s[a.a].element.style[e]="",s[a.b].element.style[e]=""}))}}))},parent:c,pairs:I}};class Pt extends re{constructor(){super(),this.sourceUrl=null,this.inited=!1,this.isLoading=!1,this.baseApiPrefix="./wabac/api",this.baseReplayPrefix="./wabac",this.apiPrefix="",this.replayPrefix="",this.coll="",this.collInfo=null,this._replaceLoc=!1,this._locUpdateNeeded=!1,this._locationHash="",this.tabData={},this.url="",this.ts="",this.tabNames=["pages","story","resources"],this.menuActive=!1,this.hasStory=!1,this.editable=!1,this.showSidebar="1"===localStorage.getItem("pages:showSidebar"),this.splitter=null}static get properties(){return{inited:{type:Boolean},sourceUrl:{type:String},loadInfo:{type:Object,attribute:!1},showSidebar:{type:Boolean},collInfo:{type:Object,attribute:!1},coll:{type:String},hasStory:{type:Boolean},isLoading:{type:Boolean},tabData:{type:Object,attribute:!1},url:{type:String},ts:{type:String},isFullscreen:{type:Boolean},menuActive:{type:Boolean},embed:{type:String},editable:{type:Boolean}}}firstUpdated(){this.inited=!0,window.addEventListener("hashchange",e=>this.onHashChange(e)),this.addEventListener("fullscreenchange",e=>{this.isFullscreen=!!document.fullscreenElement})}updated(e){if(e.has("sourceUrl")&&this.doUpdateInfo(),e.has("tabData")){if(!this.collInfo||!this.collInfo.coll)return;Object.keys(this.tabData).forEach(e=>!this.tabData[e]&&delete this.tabData[e]);const t="#"+new URLSearchParams(this.tabData).toString();if(this.tabData.url||(this.url="search://"+decodeURIComponent(this._paramsToString(this.tabData))),t!==this._locationHash){if(this._locationHash=t,this._replaceLoc||0===Object.keys(e.get("tabData")).length){const e=new URL(window.location.href);e.hash=this._locationHash,window.history.replaceState({},"",e.href),this._replaceLoc=!1}else window.location.hash=this._locationHash;this.embed&&window.parent!==window&&window.parent.postMessage(this.tabData,"*")}this._locUpdateNeeded=!1}e.has("showSidebar")&&(this.embed||localStorage.setItem("pages:showSidebar",this.showSidebar?"1":"0")),(e.has("tabData")||e.has("showSidebar"))&&this.configureSplitter()}configureSplitter(){if(this.tabData.url&&this.showSidebar){const e=this.renderRoot.querySelector("#contents"),t=this.renderRoot.querySelector("wr-coll-replay");if(e&&t&&!this.splitter){const i={sizes:[30,70],minSize:[300,300],gutterSize:4,onDragStart(){t.setDisablePointer(!0)},onDragEnd(){t.setDisablePointer(!1)}};this.splitter=Ct([e,t],i)}}else if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}}async doUpdateInfo(){let e=this.loadInfo&&this.loadInfo.customColl;if(!e){e=(await Ce(this.sourceUrl)).coll}this.coll=e;const t=this.baseApiPrefix+"/"+e,i=this.baseReplayPrefix+"/"+e,a=await fetch(t+"?all=1");if(200!=a.status)return void(this.collInfo={});const r=await a.json();this.collInfo={apiPrefix:t,replayPrefix:i,coll:e,...r},this.collInfo.title||(this.collInfo.title=this.collInfo.filename),"replayonly"===this.embed&&(this.showSidebar=!1),this.hasStory=this.collInfo.desc||this.collInfo.lists.length,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{collInfo:this.collInfo,alreadyLoaded:!0}})),this.onHashChange()}onCollLoaded(e){this.doUpdateInfo(),this.loadInfo=null,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{sourceUrl:this.sourceUrl,collInfo:this.collInfo}}))}onHashChange(e){const t=window.location.hash;if(t&&t!==this._locationHash&&(this.tabData=Object.fromEntries(new URLSearchParams(t.slice(1)).entries()),this._locationHash=t),this.collInfo.coll&&!this.tabNames.includes(this.tabData.view)){const e=this.hasStory?"story":this.collInfo.pages.length?"pages":"resources";this.tabData={...this.tabData,view:e}}if(this.tabData.url&&this.tabData.url.startsWith("page:")){const e=Number(this.tabData.url.slice("page:".length));if(!isNaN(e)&&e<this.collInfo.pages.length){const t=this.collInfo.pages[e];this.tabData.url=t.url,this.tabData.ts=$e(t).timestamp}}this.hasStory||"story"!==this.tabData.view||(this.tabData.view="pages"),this.tabData.url&&this.tabData.query&&(this.showSidebar=!0)}onTabClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");return this.tabData={...this.tabData,view:t.slice(1)},!1}onCollTabNav(e){e.target.id===this.tabData.view?this.updateTabData(e.detail.data,e.detail.replaceLoc,!1):this.showSidebar&&this.tabData.url&&this.updateTabData(e.detail.data,e.detail.replaceLoc,!0)}updateTabData(e,t=!1,i=!1){this.tabData={...this.tabData,...e},this.tabData.url&&(this.url=this.tabData.url||""),this.tabData.ts&&(this.ts=this.tabData.ts||""),this._replaceLoc=!this._locUpdateNeeded&&t,this._locUpdateNeeded=!0}static get styles(){return ue(ie`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
    ...
    @media screen and (max-width: ${me?ie`1163px`:ie`1053px`}) {
      .tab-label {
        display: none;
      }
    ...
    `}render(){if(!this.inited)return O``;const e=!!this.tabData.url,t=e&&this.showSidebar;return this.collInfo&&!this.collInfo.coll?O`
      ...
      <div id="tabContents">
        <nav id="contents" class="is-light ${t?"sidebar":e?"is-hidden":"full-pages"}">
          ${this.renderTabHeader(t)}
          ${this.renderCollTabs(t)}
        </nav>
        ...
        <ul>
          ...
          <li class="${"story"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#story" class="is-size-6">
              <span class="icon"><fa-icon .svg="${Ye.a}"></fa-icon></span>
          ...
          <li class="${"pages"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#pages" class="is-size-6">
              <span class="icon"><fa-icon .svg="${it.a}"></fa-icon></span>
          ...
          <li class="${"resources"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#resources" class="is-size-6">
              <span class="icon"><fa-icon .svg="${et.a}"></fa-icon></span>
              <span class="tab-label ${e?"is-hidden":""}" title="URL Resources">Page Resources</span>
            </a>
          </li>
          ...
          <li class="sidebar-nav right">
            <a @click="${this.onFullPageView}" class="is-marginless is-size-6 is-paddingless">
              <span>Expand</span><fa-icon title="Expand" .svg="${ut.a}"></fa-icon>
            </a>
          </li>`:""}

        </ul>
      </div>`}renderLocationBar(){if("replayonly"===this.embed)return"";const e=function(e){if(!e)return"";e.length<14&&(e+="00000000000000".substr(e.length));const t=e.substring(0,4)+"-"+e.substring(4,6)+"-"+e.substring(6,8)+"T"+e.substring(8,10)+":"+e.substring(10,12)+":"+e.substring(12,14)+"-00:00";return new Date(t)}(this.ts).toLocaleString(),t=!!this.tabData.url;return O`
    <div class="replay-bar">
      <div class="field has-addons">
        <button id="fullscreen" class="button is-borderless is-hidden-touch" @click="${this.onFullscreenToggle}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" .svg="${this.isFullscreen?lt.a:nt.a}"></fa-icon>
          </span>
        </button>
        <button class="button is-borderless is-hidden-mobile" @click="${this.onGoBack}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" .svg="${Ae.a}"></fa-icon>
          </span>
        </button>
        <button class="button is-borderless is-hidden-mobile" @click="${this.onGoForward}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" .svg="${Re.a}"></fa-icon>
          </span>
        </button>
        <button id="refresh" class="button is-borderless ${this.isLoading?"is-loading":"is-hidden-mobile"}" @click="${this.onRefresh}">
          <span class="icon is-small">
            ${this.isLoading?"":O`
            <fa-icon size="1.0em" class="has-text-grey" .svg="${rt.a}"></fa-icon>
            `}
          </span>
        </button>
        <button class="button is-borderless is-hidden-touch ${t?"":"grey-disabled"}" @click="${this.onShowPages}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" .svg="${Qe.a}"></fa-icon>
          </span>
        </button>
        ...
        <div class="dropdown is-right ${this.menuActive?"is-active":""}" @click="${e=>this.menuActive=!1}">
          <div class="dropdown-trigger">
            <button class="button is-borderless" aria-haspopup="true" aria-controls="menu-dropdown" @click="${this.onMenu}">
              <span class="icon is-small">
                <fa-icon size="1.0em" class="has-text-grey" .svg="${dt.a}"></fa-icon>
              </span>
            </button>
          </div>
          <div class="dropdown-menu" id="menu-dropdown" role="menu">
            <div class="dropdown-content">
              ...
              <a class="dropdown-item is-hidden-desktop ${t?"":"grey-disabled"}" @click="${this.onShowPages}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" .svg="${Qe.a}"></fa-icon>
                </span>
              ...
              <a href="https://replayweb.page/" target="_blank" class="dropdown-item info">
                <fa-icon class="menu-logo" size="1.0rem" .svg=${fe.a}></fa-icon>
                <span>&nbsp;About ReplayWeb.page</span>
                <span class="menu-version">(${"1.1.0-beta.2"})</span>
              </a>
              `:""}
            </div>
          </div>
    ...
    </div>`}dragStart(e){const t=this.renderRoot.querySelector("wr-coll-replay");t&&t.setDisablePointer(!0)}dragEnd(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!1)}renderCollTabs(e){const t="story"===this.tabData.view,i="pages"===this.tabData.view,a="resources"===this.tabData.view;return O`
    ${this.hasStory?O`
    ...
    `}onKeyDown(e){"Esc"!==e.key&&"Escape"!==e.key||(e.target.value=this.url)}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",()=>{this.menuActive=!1},{once:!0})}onFullscreenToggle(){this.menuActive=!1,this.isFullscreen?document.exitFullscreen():this.requestFullscreen()}onGoBack(){this.menuActive=!1,window.history.back()}onGoForward(){this.menuActive=!1,window.history.forward()}onShowPages(e){e.preventDefault(),this.showSidebar||document.documentElement.clientWidth>=769?this.showSidebar=!this.showSidebar:(this.showSidebar=!1,this.updateTabData({url:"",ts:""}))}onFullPageView(e){e.preventDefault(),this.updateTabData({url:"",ts:""})}onHideSidebar(e){e.preventDefault(),this.showSidebar=!1}onReAuthed(e){this.reauthWait=(async()=>{const t=e.detail.headers;await fetch(this.collInfo.apiPrefix+"/updateAuth",{method:"POST",body:JSON.stringify({headers:t})});this.showAuth&&(this.onRefresh(null,!0),this.showAuth=!1)})()}async onPurgeCache(e){e.preventDefault();const t=await fetch(""+this.collInfo.apiPrefix,{method:"DELETE"});200===t.status&&window.parent?window.parent.location.reload():console.warn("purge failed: "+t.status)}onSubmit(e){e.preventDefault();const t=this.renderRoot.querySelector("input").value;return this.navigateTo(t),!1}navigateTo(e){let t;t=e.startsWith("http://")||e.startsWith("https://")?{url:e}:e.startsWith("search://")?this._stringToParams(e):{query:e,view:"pages"},this.updateTabData(t)}_stringToParams(e){const t=new URLSearchParams(e.slice("search://".length)),i={};for(const e of["query","view","currList","currMime","urlSearchType"])t.has(e)&&(i[e]=t.get(e));return i}_paramsToString(e){const t=new URLSearchParams;for(const i of["query","view","currList","currMime","urlSearchType"])i in e&&t.set(i,e[i]);return t.toString()}onRefresh(e,t){if(e&&e.preventDefault(),this.menuActive=!1,this.tabData.url){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.refresh()}else window.location.reload()}}customElements.define("wr-coll",Pt);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Lt=new WeakMap,Tt=w(e=>t=>{if(!(t instanceof T))throw new Error("unsafeHTML can only be used in text bindings");const i=Lt.get(t);if(void 0!==i&&_(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=e;const r=document.importNode(a.content,!0);t.setValue(r),Lt.set(t,{value:e,fragment:r})});var Dt=i(103),Et=i.n(Dt);class At extends re{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e,t)=>{this.recalcSplitter(e[0].contentRect.width)}),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=Ct([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const t of this.collInfo.curatedPages){this.curatedPageMap[t.list]||(this.curatedPageMap[t.list]=[]);const i=e[t.page];if(!i){console.log("No Page with id: "+i);continue}const a=i.url,r=i.ts,o=i.title||i.url,n=t.desc;this.curatedPageMap[t.list].push({url:a,ts:r,title:o,desc:n})}this.scrollToList()}static get styles(){return ue(ie`
    :host {
      width: 100%;
      height: 100%;
      display: flex;
    ...
    ${At.sidebarStyles(te(":host(.sidebar)"))}
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?Tt(Et()(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return O`
    ${this.collInfo.lists.map((e,t)=>O`
    ...
    `)}`}renderCPage(e){const t=new Date(e.ts);return O`
    <li>
      <div class="content">
        <a @click="${this.onReplay}" data-url="${e.url}" data-ts="${_e(t.toISOString())}" href="#">
    ...
    <span class="icon"><fa-icon .svg="${Rt.a}"></fa-icon></span>
    <span>Authorize Google Drive</span>
    </button>
    `}`}script(){if("trypublic"===this.state||this.scriptLoaded)return O``;const e=document.createElement("script");return e.onload=()=>this.onLoad(),e.src="https://apis.google.com/js/platform.js",e}gauth(e,t){gapi.load("auth2",()=>{gapi.auth2.authorize({client_id:"160798412227-tko4c82uopud11q105b2lvbogsj77hlg.apps.googleusercontent.com",scope:"https://www.googleapis.com/auth/drive.file",response_type:"token",prompt:e},t)})}});customElements.define("wr-loader",class extends re{constructor(){super(),this.progress=0,this.total=0,this.percent=0,this.coll="",this.state="waiting",this.loadInfo=null,this.currentSize=0,this.totalSize=0,this.dbworker=ze()}static get properties(){return{sourceUrl:{type:String},loadInfo:{type:Object},state:{type:String},progress:{type:Number},percent:{type:Number},currentSize:{type:Number},totalSize:{type:Number},error:{type:String},total:{type:Number},status:{type:String},coll:{type:String},embed:{type:String}}}firstUpdated(e){this.initMessages()}initMessages(){this.dbworker.addEventListener("message",e=>{switch(e.data.msg_type){case"collProgress":e.data.name===this.coll&&(this.percent=e.data.percent,e.data.error&&(this.error=e.data.error,this.state="errored"),e.data.currentSize&&e.data.totalSize&&(this.currentSize=e.data.currentSize,this.totalSize=e.data.totalSize));break;case"collAdded":e.data.name===this.coll&&(this.total||(this.total=100),this.progress=this.total,this.percent=100,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:e.data})))}})}async doLoad(){let e=this.sourceUrl,t=null;if(this.percent=this.currentSize=this.totalSize=0,!navigator.serviceWorker)return this.state="errored",void(this.error="Sorry, this browser is not supported. Please try a different browser\n(If you're using Firefox, try without Private Mode)");try{const{scheme:i,host:a,path:r}=function(e){let t=e.indexOf("://"),i=0,a="",r="",o="";return t>=0?(a=e.slice(0,t),t+=3):(t++,e.startsWith("//")&&(t+=2)),i=e.indexOf("/",t),i>0?(r=e.slice(t,i),o=e.slice(i)):(r=e.slice(t),o=""),{scheme:a,host:r,path:o}}(e);switch(i){case"googledrive":this.state="googledrive",t=await this.googledriveInit();break;case"s3":t={sourceUrl:e,loadUrl:`https://${a}.s3.amazonaws.com${r}`,name:this.sourceUrl};break;case"file":if(!this.loadInfo)return this.state="errored",void(this.error="File URLs can not be entered directly or shared.\nYou can select a file to upload from the main page by clicking the 'Choose File...' button.");t=this.loadInfo}}catch(e){}t||(t={sourceUrl:e}),this.state="started";const i={msg_type:"addColl",name:this.coll,skipExisting:!0,file:t};this.loadInfo&&this.loadInfo.extraConfig&&(i.extraConfig=this.loadInfo.extraConfig),this.dbworker.postMessage(i)}googledriveInit(){return this._gdWait=new Promise(e=>this._gdResolve=e),this._gdWait}async onLoadReady(e){this._gdResolve&&this._gdResolve(e.detail)}onCancel(){this.dbworker.postMessage({msg_type:"cancelLoad",name:this.coll})}updated(e){this.sourceUrl&&e.has("sourceUrl")&&this.doLoad()}static get styles(){return ue(ie`
      :host {
        height: 100%;
        display: flex;
      }
    ...
    `}renderContent(){switch(this.state){case"googledrive":return O`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return O`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?O`
              <p class="loaded-prog">Loaded <b>${Le()(this.currentSize)}</b> of <b>${Le()(this.totalSize)}</b></p>`:O``}
          ...
          <div>
          ${this.embed?O`
          <a class="button is-warning" @click=${e=>window.parent.location.reload()}>Try Again</a>`:O`
          <a href="/" class="button is-warning">Back</a>`}
          </div>`;case"waiting":default:return O`<progress class="progress is-primary is-large" style="max-width: 400px"/>`}}});var Ut=i(105),jt=i.n(Ut),qt=i(106),Mt=i.n(qt),Nt=i(107),Ot=i.n(Nt);class Bt extends re{constructor(){super(),this.filteredPages=[],this.sortedPages=[],this.query="",this.flex=null,this.newQuery=null,this.loading=!1,this.updatingSearch=!1,this.currList=0,this.active=!1,this.editable=!1,this.changeNeeded=!1,this.selectedPages=new Set,this.menuActive=!1,this.sortKey=null,this.sortDesc=null,this.isSidebar=!1,this.url="",this.ts=""}static get sortKeys(){return[{key:"",name:"Best Match"},{key:"title",name:"Title"},{key:"ts",name:"Date"}]}static get properties(){return{active:{type:Boolean},collInfo:{type:Object},currList:{type:Number},filteredPages:{type:Array},sortedPages:{type:Array},query:{type:String},defaultKey:{type:String},loading:{type:Boolean},updatingSearch:{type:Boolean},editable:{type:Boolean},selectedPages:{type:Set},allSelected:{type:Boolean},menuActive:{type:Boolean},sortKey:{type:String},sortDesc:{type:Boolean},isSidebar:{type:Boolean},url:{type:String},ts:{type:String}}}_timedUpdate(){null!==this.newQuery&&(this.query=this.newQuery,this.newQuery=null,this.filter())}async updated(e){if(e.has("collInfo")?this.updateTextSearch():e.has("query")?(this.query&&!e.get("query")&&(this.sortKey=null,this.sortDesc=null),this.filter()):e.has("currList")&&this.filter(),e.has("active")&&this.active&&this.changeNeeded&&this.filter(),e.has("sortedPages")&&this.isSidebar){const e=this.renderRoot.querySelector(".current");if(e){const t={behavior:"smooth",block:"nearest",inline:"nearest"};setTimeout(()=>e.scrollIntoView(t),100)}}}onChangeQuery(e){this.newQuery=e.currentTarget.value,this._ival&&window.clearTimeout(this._ival),this._ival=window.setTimeout(()=>this._timedUpdate(),250)}async filter(){if(this.loading)return;if(this.active||(this.changeNeeded=!0),this.loading=!0,this.flex&&this.query){const e=await this.flex.search(this.query,{limit:25});this.filteredPages=e}else this.filteredPages=[...this.collInfo.pages];0!==this.currList&&await this.filterCurated(),this.loading=!1,this.changeNeeded=!1;const e={query:this.query,currList:this.currList};this.sendChangeEvent(e)}async filterCurated(){const e=await fetch(`${this.collInfo.apiPrefix}/curated/${this.currList}`),t=await e.json(),i=[];for(const e of t.curated)for(const t of this.filteredPages)if(t.id===e.page){i.push(t);break}this.filteredPages=i}sendChangeEvent(e){this.dispatchEvent(new CustomEvent("coll-tab-nav",{detail:{data:e}}))}async updateTextSearch(){if(this.updatingSearch)return;this.updatingSearch=!0;let e=0;try{const i=new Mt.a({doc:{id:"id",field:["url","title","text"]},async:!0});this.flex=i;const a=await caches.open("cache:"+this.collInfo.coll),r=this.collInfo.apiPrefix+"/textIndex";let o=await a.match(r);o&&Number(o.headers.get("Content-Length"))||(o=await fetch(this.collInfo.apiPrefix+"/textIndex"),200===o.status&&Number(o.headers.get("Content-Length"))&&a.put(r,o.clone()));let n=[];async function t(){let t=n;n=[],await i.add(t),console.log("added "+e+" "+t.length),console.log(i.info())}for await(const i of jt()(o.body.getReader()))i.text&&(i.id=++e,n.push(i),e%100==0&&await t());await t()}finally{0===e&&this.flex.add(this.collInfo.pages),this.updatingSearch=!1}await this.filter()}static get styles(){return ue(ie`
      :host {
        width: 100%;
        height: 100%;
        display: flex;
      ...
      ${Bt.sidebarStyles(te`:host(.sidebar)`)}
    ...
    <div class="search-bar notification is-marginless">
      ...
      ${this.isSidebar&&this.collInfo.lists.length?O`
      <div class="is-hidden-tablet mobile-lists">
        ...
        <div class="select is-small">
          ...
          <option value="0" ?selected="${0===this.currList}">All Pages</option>
          ${this.collInfo.lists.map(e=>O`
            <option value="${e.id}" ?selected="${this.currList===e.id}">${e.title}</option>
          `)}
          </select>
        </div>
      </div>`:""}
    ...
    </div>`}renderDownloadMenu(){return O`
      <div class="dropdown ${this.menuActive?"is-active":""}">
        ...
        <div class="dropdown-menu" id="dropdown-menu" role="menu">
          <div class="dropdown-content">
            ...
            <a @click="${e=>this.onDownload(e,"warc",!0)}" class="dropdown-item">
            ...
            <a @click="${e=>this.onDownload(e,"warc",!1)}" class="dropdown-item">
    ...
    <div class="header columns is-hidden-mobile">
      ...
      <a @click="${this.onSort}" data-key="ts" class="column is-2 ${"ts"===this.sortKey?this.sortDesc?"desc":"asc":""}">Date</a>
      <a @click="${this.onSort}" data-key="title" class="column is-6 pagetitle ${"title"===this.sortKey?this.sortDesc?"desc":"asc":""}">Page Title</a>
    </div>
    ...
    <div class="is-hidden-tablet mobile-header">
      ...
      .defaultDesc="${null!==this.sortDesc?this.sortDesc:!this.query}"
      .sortKeys="${Bt.sortKeys}"
      .data="${this.filteredPages}"
      @sort-changed="${this.onSortChanged}"
      class="${this.filteredPages.length?"":"is-hidden"}">
      </wr-sorter>
    </div>
    `}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=_e(e.date):"string"==typeof e.ts&&(t=_e(e.ts)),t===this.ts}return!!this.editable&&this.selectedPages.has(p.id)}renderPages(){return O`
      <div class="page-header has-text-weight-bold">
      ${this.renderPageHeader()}
      </div>
      <div class="scroller" @scroll="${this.onScroll}">
        ${this.sortedPages.length?O`
          ${this.sortedPages.map((e,t)=>{const i=this.isCurrPage(e);return O`
          <div class="content ${i?"current":""}">
            <wr-page-entry
            .index="${this.query||this.isSidebar?t+1:0}"
            .editable="${this.editable}"
            .selected="${this.selectedPages.has(e.id)}"
            .isCurrent="${i}"
            .page="${e}"
          ...
          </div>`})}`:O`<p class="mobile-header">${this.getNoResultsMessage()}</p>`}
      </div>
    `}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",()=>{this.menuActive=!1},{once:!0})}onSort(e){e.preventDefault();const t=e.currentTarget.getAttribute("data-key")||"";t===this.sortKey?this.sortDesc=!this.sortDesc:(this.sortDesc=!1,this.sortKey=t)}onSortChanged(e){this.sortedPages=e.detail.sortedData,this.sortKey=e.detail.sortKey,this.sortDesc=e.detail.sortDesc}onSelectToggle(e){const{page:t,selected:i}=e.detail;i?this.selectedPages.add(t):this.selectedPages.delete(t),this.allSelected=this.selectedPages.size===this.sortedPages.length,this.requestUpdate()}onSelectAll(e){this.allSelected=e.currentTarget.checked,this.allSelected?this.sortedPages.forEach(e=>{this.selectedPages.add(e.id)}):this.selectedPages.clear(),this.requestUpdate()}async onDownload(e,t,i){e.preventDefault();const a=new URLSearchParams;a.set("pages",i?Array.from(this.selectedPages.keys()).join(","):"all"),a.set("format",t),this.collInfo.filename&&a.set("filename",this.collInfo.filename),window.location.href=this.collInfo.apiPrefix+"/dl?"+a.toString()}async onDeletePage(e){const t=e.currentTarget.page,i=await fetch(`${this.collInfo.apiPrefix}/page/${t.id}`,{method:"DELETE"}),a=(await i.json(),this.collInfo.pages.indexOf(t));a<0||(this.collInfo.pages.splice(a,1),this.updateTextSearch(),this.requestUpdate())}formatResults(){return 1===this.sortedPages.length?"1 Page Found":this.sortedPages.length+" Pages Found"}getNoResultsMessage(){return this.collInfo&&this.collInfo.pages.length?this.updatingSearch?"Initializing Search...":this.loading?"Searching...":this.query?"No Pages Found":"No Pages Found. Try changing the search query.":O`No Pages defined this archive. Check out&nbsp;<a href="#view=resources">Page Resources</a>&nbsp;to search by URL.`}onScroll(e){const t=e.currentTarget;if(t.scrollHeight-t.scrollTop-t.clientHeight<40){const e=this.renderRoot.querySelector("wr-sorter");e&&e.getMore()}}}customElements.define("wr-page-view",Bt);const Gt=new RegExp(`[${["-","[","]","/","{","}","(",")","*","+","?",".","\\","^","$","|"].join("\\")}]`,"g"),Ht=e=>e.replace(Gt,"\\$&");class Ft extends HTMLElement{static get observedAttributes(){return["keywords"]}get keywords(){return this.getAttribute("keywords")||""}set keywords(e){this.setAttribute("keywords",e)}constructor(){super(),this.attachShadow({mode:"open"})}attributeChangedCallback(e,t,i){"keywords"===e&&i!==t&&this._render()}connectedCallback(){this._render(),this.__observer=new MutationObserver(()=>{this._render()}),this.__observer.observe(this,{childList:!0,characterData:!0,subtree:!0})}disconnectedCallback(){this.__observer&&(this.__observer.disconnect(),this.__observer=void 0)}_render(){if(!this.shadowRoot)return;const e=this.textContent||"",t=this.getAttribute("keywords");if(!t)return void(this.shadowRoot.textContent=e);const i=e.toLowerCase(),a=t.toLowerCase().split(/\s+/),r=new RegExp(""+a.map(Ht).join("|"),"gi"),o=e.split(r),n=document.createElement("div");let s=0;for(const t of o)if(n.appendChild(document.createTextNode(t)),s+=t.length,s<i.length){const t=i.substring(s),r=a.find(e=>t.startsWith(e));if(r){const t=document.createElement("mark");t.textContent=e.substr(s,r.length),n.appendChild(t),s+=r.length}}this.shadowRoot.innerHTML=`\n      <style>\n        mark {\n          color: var(--keyword-mark-color);\n          background: var(--keyword-mark-background, yellow);\n        }\n      </style>\n      ${n.innerHTML}\n    `}}customElements.define("keyword-mark",Ft);class Wt extends re{constructor(){super(),this.query="",this.textSnippet="",this.page=null,this.replayPrefix="",this.deleting=!1,this.editable=!1,this.iconValid=!1,this.index=0,this.isCurrent=!1,this.timestamp="",this.date=null}static get properties(){return{query:{type:String},textSnippet:{type:String},page:{type:Object},replayPrefix:{type:String},deleting:{type:Boolean},selected:{type:Boolean},editable:{type:Boolean},iconValid:{type:Boolean},index:{type:Number},isCurrent:{type:Boolean},timestamp:{type:String},date:{type:Object}}}static get styles(){return ue(ie`
      :host {
      ...
      ${Wt.sidebarStyles(te`:host(.sidebar)`)}
    ...
    `}updated(e){if(e.has("page")||e.has("query")){this.updateSnippet(),this.iconValid=!!this.page.favIconUrl,this.deleting=!1;const e=$e(this.page);this.timestamp=e.timestamp,this.date=e.date}}render(){const e=this.page,t=this.date,i="number"==typeof e.size;return O`
    ${this.editable?O`
    <div class="check-select">
      <label class="checkbox">
      ...
      <div class="column">
        <article class="media">
          <figure class="media-left">
            <p class="">
            ${this.iconValid?O`
              <img class="favicon" @error="${e=>this.iconValid=!1}" src="${this.replayPrefix}/${this.timestamp}id_/${e.favIconUrl}"/>`:O`
              <span class="favicon"></span>`}
            </p>
          </figure>
          <div class="media-content ${this.isCurrent?"current":""}">
            <a @click="${this.onReplay}" href="#">
            ${this.isCurrent?O`<p class="curr-page is-pulled-right">Current Page</p>`:""}
      ...
      <div class="modal-background"></div>
        <div class="modal-card">
          ...
          <section class="modal-card-body">
            ...
            <wr-gdrive .sourceUrl=${this.sourceUrl} .state="${this.showAuth?"trymanual":"implicitonly"}" .reauth="${!0}" @load-ready=${this.onReAuthed}/>
            </div>
          </section>
        </div>
    </div>
    `:""}
    `}});var Vt=i(108),Kt=i.n(Vt),Zt=i(109),Yt=i.n(Zt);customElements.define("wr-sorter",class extends re{constructor(){super(),this.sortedData=[],this.data=[],this.numResults=100,this.sortKey=null,this.sortDesc=null,this.defaultKey="",this.defaultDesc=!1}static get properties(){return{id:{type:String},defaultKey:{type:String},defaultDesc:{type:Boolean},data:{type:Array},sortedData:{type:Array},sortKey:{type:String},sortDesc:{type:Boolean}}}updated(e){const t=e.has("sortKey"),i=e.has("sortDesc"),a=e.has("data");e.has("numResults");e.has("defaultKey")&&(this.sortKey=this.defaultKey),e.has("defaultDesc")&&(this.sortDesc=this.defaultDesc),t&&localStorage.setItem(this.id+":sortKey",this.sortKey),i&&localStorage.setItem(this.id+":sortDesc",this.sortDesc?"1":"0"),(t||i||a)&&this.sortData()}sortData(){this.sortedData=[...this.data],this.numResults=100,""===this.sortKey?this.sortDesc&&this.sortedData.reverse():this.sortedData.sort((e,t)=>e[this.sortKey]===t[this.sortKey]?0:this.sortDesc==e[this.sortKey]<t[this.sortKey]?1:-1),this.sendSortChanged()}sendSortChanged(){const e={sortKey:this.sortKey,sortDesc:this.sortDesc,sortedData:this.sortedData.slice(0,this.numResults)};this.dispatchEvent(new CustomEvent("sort-changed",{detail:e}))}getMore(e=100){this.numResults>=this.sortedData.length||(this.numResults+=e,this.sendSortChanged())}static get styles(){return ue(ie`
      :host {
        min-width: 100px;
        box-sizing: border-box !important;
      }
    ...
    <div class="notification level is-marginless">
      ...
      <div class="control level-right">
        <div style="margin-left: 1em" class="control">
          <label class="radio has-text-left"><input type="radio" name="urltype" value="" ?checked="${"contains"===this.urlSearchType}" @click="${this.onClickUrlType}">&nbsp;Contains</label>
    ...
    <div class="sort-header is-hidden-tablet">
      <wr-sorter id="urls"
        ...
        ?defaultDesc="${null!==this.sortDesc&&this.sortDesc}"
        .sortKeys="${Jt.sortKeys}"
    ...
    <div class="all-results">
      <div class="columns results-head has-text-weight-bold">
        <a @click="${this.onSort}" data-key="url" class="column col-url is-6 is-hidden-mobile ${"url"===this.sortKey?this.sortDesc?"desc":"asc":""}">URL</a>
        <a @click="${this.onSort}" data-key="ts" class="column col-ts is-2 is-hidden-mobile ${"ts"===this.sortKey?this.sortDesc?"desc":"asc":""}">Date</a>
        <a @click="${this.onSort}" data-key="mime" class="column col-mime is-3 is-hidden-mobile ${"mime"===this.sortKey?this.sortDesc?"desc":"asc":""}">Mime Type</a>
        <a @click="${this.onSort}" data-key="status" class="column col-status is-1 is-hidden-mobile ${"status"===this.sortKey?this.sortDesc?"desc":"asc":""}">Status</a>
      </div>

      <div class="main-scroll" @scroll="${this.onScroll}">
      ${this.sortedResults.length?this.sortedResults.map(e=>O`
          <div class="columns result">
            <div class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="#">${e.url}</a></div>
            <div class="column col-ts is-2"><p class="minihead is-hidden-tablet">Date</p>${new Date(e.date).toLocaleString()}</div>
            <div class="column col-mime is-3"><p class="minihead is-hidden-tablet">Mime Type</p>${e.mime}</div>
            <div class="column col-status is-1"><p class="minihead is-hidden-tablet">Status</p>${e.status}</div>
          </div>
        `):O`<div class="section"><i>No Results Found.</i></div>`}
      </div>
    </div>
    `}onSort(e){e.preventDefault();const t=e.currentTarget.getAttribute("data-key");t===this.sortKey?this.sortDesc=!this.sortDesc:(this.sortDesc=!1,this.sortKey=t)}onSortChanged(e){this.sortedResults=e.detail.sortedData,this.sortKey=e.detail.sortKey,this.sortDesc=e.detail.sortDesc}onReplay(e){e.preventDefault();const t={url:e.currentTarget.getAttribute("data-url"),ts:e.currentTarget.getAttribute("data-ts")};return this.dispatchEvent(new CustomEvent("coll-tab-nav",{detail:{data:t}})),!1}}customElements.define("wr-coll-resources",Jt);var Qt=document.currentScript&&document.currentScript.src;class Xt extends re{constructor(){super(),this.replaybase=window.location.origin+"/replay/",this.swName="sw.js",this.view="replay",this.ts="",this.url="",this.query="",this.config="",this.coll="",this.paramString=null,this.deepLink=!1,this.swInited=!1,this.embed=null,this.reloadCount=0}static get properties(){return{url:{type:String},ts:{type:String},query:{type:String},source:{type:String},view:{type:String},embed:{type:String},replaybase:{type:String},swName:{type:String},title:{type:String},coll:{type:String},config:{type:String},swInited:{type:Boolean},paramString:{type:String},hashString:{type:String},deepLink:{type:Boolean},noSW:{type:Boolean}}}async doRegister(){try{await ye(this.swName,this.replaybase),console.log("done"),this.swInited=!0}catch(e){console.log(e),this.noSW=!0}}firstUpdated(){this.doRegister(),window.addEventListener("message",e=>{const t=this.renderRoot.querySelector("iframe");if(t&&e.source===t.contentWindow){if(e.data.title&&(this.title=e.data.title),!this.deepLink)return;const t=new URLSearchParams(e.data),i=new URL(window.location.href);i.hash="#"+t.toString(),window.history.replaceState({},"",i)}}),this.deepLink&&(this.updateFromHash(),window.addEventListener("hashchange",e=>this.updateFromHash()))}updateFromHash(){const e=new URLSearchParams(window.location.hash.slice(1));e.has("url")&&(this.url=e.get("url")),e.has("ts")&&(this.ts=e.get("ts")),e.has("query")&&(this.query=e.get("query")),e.has("view")&&(this.view=e.get("view"))}updated(e){(e.has("url")||e.has("ts")||e.has("query")||e.has("view")||e.has("source"))&&(this.embed=this.embed||"default",this.paramString=new URLSearchParams({source:this.source,customColl:this.coll,config:this.config,basePageUrl:window.location.href.split("#")[0],embed:this.embed}).toString(),this.hashString=new URLSearchParams({url:this.url,ts:this.ts,query:this.query,view:this.view}).toString())}static get styles(){return ue(ie`
      .logo {
        margin: 1em;
        flex-grow: 1;
      }
    ...
    ${this.noSW?O`
      <section class="full-width">
        <div class="has-text-centered">
          <fa-icon class="logo" id="wrlogo" size="2.5rem" .svg=${fe.a}></fa-icon>
        </div>
        <div class="error">

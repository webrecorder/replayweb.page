 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class he extends de{constructor(e){if(super(e),this.et=N,e.type!==le)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===N||null==e)return this.ft=void 0,this.et=e;if(e===F)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}he.directiveName="unsafeHTML",he.resultType=1;const fe=ce(he);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
class ue extends he{}ue.directiveName="unsafeSVG",ue.resultType=2;const be=ce(ue),pe="important",me=ce(class extends de{constructor(e){var t;if(super(e),e.type!==se||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const r=e[i];return null==r?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach((e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const r=t[e];if(null!=r){this.ht.add(e);const t="string"==typeof r&&r.endsWith(" !important");e.includes("-")||t?i.setProperty(e,t?r.slice(0,-11):r,t?pe:""):i[e]=r}}return F}});var ge=__webpack_require__(6274),ve=__webpack_require__(3029),we=__webpack_require__.n(ve);const xe=o(ge.Z);function ke(e){return[xe,e]}const ye=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,_e="1.8.7";function $e(e){" "==e.key&&(e.preventDefault(),e.target.click())}class Se extends oe{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return n`
    :host {
    ...
    `}render(){if(!this.svg)return j``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),j`<svg style="${me(e)}"><g>${be(this.svg)}</g></svg>`}}customElements.define("fa-icon",Se),customElements.define("wr-anim-logo",class extends Se{constructor(){super(),this.svg=we()}static get styles(){return n`
    #wrlogo #stop5687 {
    ...
    `}get mainLogo(){return we()}renderNavBrand(){return j`
    ...
    <nav class="navbar has-background-info" aria-label="main">
      <div class="navbar-brand">
        ...
        `:j`
          ...
          `:""}
          `}
        <a href="#" role="button" id="menu-button" @click="${this.onNavMenu}" @keyup="${$e}"
      ...
      <div class="navbar-menu ${this.navMenuShown?"is-active":""}">
        <div class="navbar-start">
          ${ye?j`
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Back" @click="${()=>window.history.back()}" @keyup="${$e}">
              <fa-icon size="1.0rem" .svg="${Ee()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Back</span>
            </a>
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${()=>window.history.forward()}" @keyup="${$e}">
              <fa-icon size="1.0rem" .svg="${Pe()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Forward</span>
            </a>
          `:""}
        </div>
        ${this.embed?j``:j`
    ...
    <p id="skip-main-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderNavEnd(){return j`
      <a href="/docs" target="_blank" class="navbar-item is-size-6">
      <fa-icon .svg="${Ae()}" aria-hidden="true"></fa-icon><span>&nbsp;User Docs</span>
    </a>
    <!--
    ...
    @about-show=${()=>this.showAbout=!0}></wr-coll>`}renderHomeIndex(){return j`
      <wr-coll-index>
      ${ye?"":j`
  ...
  `)}render(){return j`
            ...
            <label class="file-label">
              ...
              <span class="file-cta" @click="${this.onChooseNativeFile}">
                <span class="file-icon">
                  <fa-icon size="0.9em" .svg=${Fe()} aria-hidden="true"></fa-icon>
                </span>
    ...
    `}renderHeader(){return j`<h2 class="panel-heading panel-color"><span>${this.headerName}</span></h2>`}renderSearchHeader(){return""}render(){const e=this.childElementCount>0;return j`
        ...
        <div class="coll-list">
          ${this.sortedColls&&this.sortedColls.map(((e,t)=>j`
            <div class="coll-block panel-block">
              ...
              ${this._deleting[e.sourceUrl]?j`
              <span class="button delete-button is-loading is-static">Deleting</span`:j`
    ...
    `}renderCollInfo(e){return j`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return j`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Xe extends oe{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return ke(Xe.compStyles)}static get compStyles(){return n`
    .columns {
      width: 100%;
    }
    .column {
  ...
  <div class="column is-4">
    ...
    ${e.sourceUrl&&(e.sourceUrl.startsWith("http://")||e.sourceUrl.startsWith("https://"))?j`
    <a href="${e.sourceUrl}">${e.sourceUrl}&nbsp;</a>`:j`
    ${e.sourceUrl}&nbsp;`}
    </span>

    <a @click="${t=>this.onCopy(t,e.sourceUrl)}" class="copy"><fa-icon .svg="${We()}"/></a>
    ${e.sourceUrl&&e.sourceUrl.startsWith("googledrive://")?j`
      <p><i>(${e.filename})</i></p>`:""}
  </div>
  ...
  `}renderSummaryView(){const e=this.coll;return j`
    <div class="columns">
      ...
      ${this.renderSource(e)}
    </div>`}renderDetailed(){const e=this.coll;let{numValid:t,numInvalid:i,domain:r,certFingerprint:a,datapackageHash:o,publicKey:n,software:s}=this.coll.verify||{};t=t||0,i=i||0;const l=a?`https://crt.sh/?q=${a}`:"";return j`
      <div class="columns">
        <div class="column col-title is-4">
          <span class="subtitle has-text-weight-bold">
            ${e.title||e.filename}
        ...
        <div class="column">
          ...
          <p>${r}</p>
          ${l?j`<span><a target="_blank" href="${l}">View Certificate</a></span>`:""}
        </div>
        `:s?j`
        <div class="column">
        ...
        <div class="column">
          ...
          ${t>0||i>0?j`
          <p>${t} hashes verified${i?j`, ${i} invalid`:""}</p>`:j`
          Not Available`}
        </div>
    ...
    <div class="dropdown mb-4 ${this.active?"is-active":""}">
      <div class="dropdown-trigger embed-info-container">
        <button class="embed-info is-small is-rounded mt-4" aria-haspopup="true" aria-controls="embed-dropdown" @click="${this.onEmbedDrop}">
          <fa-icon class="menu-logo mr-2 embed-globe" size="1rem" aria-hidden="true" .svg=${Pt()}></fa-icon>
          ...
          <span class="icon is-small mr-4 ml-2">
            <fa-icon title="Toggle" .svg="${this.active?Rt():Tt()}" aria-hidden="true"></fa-icon>
          </span>
        </button>
      </div>
      <div class="dropdown-menu embed-info-container" id="embed-dropdown" role="menu">
        <div class="dropdown-content embed-info-drop">
          ...
          <a href="${s}" class="button is-primary mt-4" @keyup="${$e}">
            <span class="icon is-small">
              <fa-icon size="1.0em" aria-hidden="true" .svg="${lt()}"></fa-icon>
            </span>
          ...
          <div class="embed-info-drop-statscontainer mb-4">
            ...
            ${e>0||t>0?j`
            <p>${e} hashes verified${t?j`, ${t} invalid`:""}</p>`:j`
            <p>Not Available</p>
            `}
            <h3 class="mt-2">Package Hash:</h3>
            <p class="show-hash">${a}</p>
            <h3 class="mt-2">Size</h3>
            <p>${Be()(Number(this.collInfo.size||0))}</p>
          </div>
          ${s?j`
          `:""}
          <p class="is-size-7 is-flex is-justify-content-space-between" style="margin-top: 40px">
            ...
            <span>
              <a class="has-text-black" target="_blank" href="https://github.com/webrecorder/replayweb.page">Source Code
                <fa-icon class="menu-logo ml-1" size="1.0rem" aria-hidden="true" .svg=${Mt()}></fa-icon>
              </a>
            </span>
          </p>
        </div>
    ...
    ${ti.replayBarStyles}`}static get replayBarStyles(){return n`
    .breadbar {
      display: flex;
      align-items: center;
      height: 35px;
    ...
    `}render(){if(!this.inited)return j``;const e=!!this.tabData.url,t=e&&this.showSidebar;if(!e&&this.tabData&&this.tabData.view){const e={title:this.tabLabels[this.tabData.view],replayTitle:!1};this.dispatchEvent(new CustomEvent("update-title",{bubbles:!0,composed:!0,detail:e}))}return this.collInfo&&!this.collInfo.coll?j`
      <wr-loader .loadInfo="${this.loadInfo}" embed="${this.embed}" swName="${this.swName}"
      .coll="${this.coll}" .sourceUrl="${this.sourceUrl}" @coll-loaded=${this.onCollLoaded}></wr-loader>`:this.collInfo?j`
      ...
      `:j``}renderTabHeader(e){return j`
      <nav class="main tabs is-centered ${e?"sidebar":""}" aria-label="tabs">
        <ul>
          ${e?j`
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${this.onHideSidebar}" @keyup="${$e}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${At()}" aria-hidden="true"></fa-icon>
          ...
          <li class="${"story"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#story" class="is-size-6" aria-label="Story" aria-current="${"story"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${nt()}" aria-hidden="true" title="Story"></fa-icon></span>
          ...
          <li class="${"pages"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#pages" class="is-size-6" aria-label="Pages" aria-current="${"pages"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${bt()}" aria-hidden="true" title="Pages"></fa-icon></span>
          ...
          <li class="${"resources"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#resources" class="is-size-6" aria-label="URLs" aria-current="${"resources"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${ft()}" aria-hidden="true" title="URLs"></fa-icon></span>
          ...
          <li class="${"info"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#info" class="is-size-6" aria-label="Archive Info" aria-current="${"info"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${mt()}" aria-hidden="true" title="Archive Info"></fa-icon></span>
          ...
          <li class="sidebar-nav right">
            <a role="button" href="#" @click="${this.onFullPageView}" @keyup="${$e}" class="is-marginless is-size-6 is-paddingless">
              <span class="nav-hover" aria-hidden="true">Expand</span>
              <span class="is-sr-only">Expand Sidebar to Full View</span>
              <fa-icon title="Expand" .svg="${Et()}" aria-hidden="true"></fa-icon>
            </a>
          </li>`:""}
        </ul>
      </nav>`}renderLocationBar(){if("replayonly"===this.embed||"replay-with-info"==this.embed)return"";const e=et(this.ts).toLocaleString(),t=!!this.tabData.url,i=t&&this.favIconUrl;return j`
    ...
    <nav class="replay-bar" aria-label="replay">
      <div class="field has-addons">
        <a href="#" role="button" class="button narrow is-borderless is-hidden-touch" id="fullscreen" @click="${this.onFullscreenToggle}" @keyup="${$e}"
                title="${this.isFullscreen?"Exit Full Screen":"Full Screen"}" aria-label="${this.isFullscreen?"Exit Fullscreen":"Fullscreen"}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?$t():yt()}"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoBack}" @keyup="${$e}"
                title="Back" aria-label="Back">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Ee()}"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoForward}" @keyup="${$e}"
                title="Forward" aria-label="Forward">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Pe()}"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" class="button narrow is-borderless ${this.isLoading?"is-loading":"is-hidden-mobile"}" id="refresh" @click="${this.onRefresh}" @keyup="${$e}"
        ...
        ${this.browsable?j`
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile ${t?"":"grey-disabled"}" @click="${this.onShowPages}" @keyup="${$e}"
        ...
        <form @submit="${this.onSubmit}">
          <div class="control is-expanded ${i?"has-icons-left":""}">
            ...
            ${t?j`<p id="datetime" class="control is-hidden-mobile">${e}</p>`:j``}
            ${i?j`
        ...
        <div class="dropdown is-right ${this.menuActive?"is-active":""}" @click="${()=>this.menuActive=!1}">
          <div class="dropdown-trigger">
            <button class="button is-borderless" aria-haspopup="true" aria-controls="menu-dropdown" aria-expanded="${this.menuActive}" @click="${this.onMenu}"
              ...
              <span class="icon is-small">
                <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${zt()}"></fa-icon>
              </span>
            </button>
          </div>
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              <a href="#" role="button" class="dropdown-item is-hidden-desktop" @click="${this.onFullscreenToggle}" @keyup="${$e}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?$t():yt()}"></fa-icon>
                </span>
                <span>Full Screen</span>
              </a>
              <a href="#" role="button" class="dropdown-item is-hidden-tablet" @click="${this.onGoBack}" @keyup="${$e}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Ee()}"></fa-icon>
                </span>
                <span>Back</span>
              </a>
              <a href="#" role="button" class="dropdown-item is-hidden-tablet" @click="${this.onGoForward}" @keyup="${$e}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Pe()}"></fa-icon>
                </span>
                <span>Forward</span>
              </a>
              <a href="#" role="button" class="dropdown-item is-hidden-tablet" @click="${this.onRefresh}" @keyup="${$e}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${xt()}"></fa-icon>
                </span>
                <span>Reload</span>
              ...
              ${this.browsable?j`
              <a href="#" role="button" class="dropdown-item is-hidden-tablet ${t?"":"grey-disabled"}" @click="${this.onShowPages}" @keyup="${$e}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${dt()}"></fa-icon>
                </span>
              ...
              <a href="#" role="button" class="dropdown-item" @click="${this.onPurgeCache}" @keyup="${$e}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${vt()}"></fa-icon>
                </span>
                <span>Purge Cache + Full Reload</span>
              </a>`:j``}
              ${!this.editable&&this.sourceUrl.startsWith("http://")||this.sourceUrl.startsWith("https://")?j`
              <hr class="dropdown-divider">
              <a href="${this.sourceUrl}" role="button" class="dropdown-item" @keyup="${$e}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${lt()}"></fa-icon>
                </span>
                <span>Download Archive</span>
              </a>`:j``}
              ${e?j`
    ...
    </nav><p id="skip-replay-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderVerifyInfo(){return"replay-with-info"!==this.embed?"":j`<rwp-embed-receipt
            .collInfo=${this.collInfo}
            url=${this.url}
            ts=${this.ts}
            .appLogo=${this.appLogo}
            >
            </rwp-embed-receipt>`}dragStart(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!0)}dragEnd(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!1)}renderCollInfo(){return j`
    <div class="info-bg">
      <wr-coll-info
      class="is-list"
      .coll="${this.collInfo}"
    ...
    ${Fi.sidebarStyles(o(":host(.sidebar)"))}
        ...
        <aside class="menu">
          <ul class="menu-list">
            <li>
              ...
              <ul class="menu-list">${this.collInfo.lists.map((t=>j`
                <li>
  ...
  `}renderLists(){return j`
    ${this.collInfo.lists.map((e=>j`
    ...
    `))}`}renderCPage(e){const t=new Date(e.ts),i=it(t.toISOString());return j`
    <li>
      <div class="content">
    ...
    `}renderContent(){switch(this.state){case"googledrive":return j`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return j`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?j`
    ...
    ${!this.isSidebar&&this.editable&&this.filteredPages.length?j`
    ...
    <div class="header columns is-hidden-mobile">
      ${this.query?j`
      <a role="button" href="#" @click="${this.onSort}" @keyup="${$e}" data-key="" class="column is-1 ${""===this.sortKey?this.sortDesc?"desc":"asc":""}">Match</a>`:""}

      <a role="button" href="#" @click="${this.onSort}" @keyup="${$e}" data-key="date" class="column is-2 ${"date"===this.sortKey?this.sortDesc?"desc":"asc":""}">Date</a>
      <a role="button" href="#" @click="${this.onSort}" @keyup="${$e}" data-key="title" class="column is-6 pagetitle ${"title"===this.sortKey?this.sortDesc?"desc":"asc":""}">Page Title</a>
    </div>
    ...
    `}renderDeleteModal(){return this.toDeletePages?j`
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.toDeletePages=this.toDeletePage=null}" title="Confirm Delete">
      ...
      (Size: <b>${Be()(this.toDeletePage.size)}</b>)</p>`:j`
      ...
      <ul class="scroller" @scroll="${this.onScroll}">
        ${this.sortedPages.length?j`
          ${this.sortedPages.map(((e,t)=>{const i=this.selectedPages.has(e.id);return j`
      ...
      <div class="column">
        <div class="media">
          <figure class="media-left">
            <p class="">
            ${this.iconValid?j`
              <img class="favicon" @error="${()=>this.iconValid=!1}" src="${this.replayPrefix}/${this.page.timestamp}id_/${e.favIconUrl}"/>`:j`
              <span class="favicon"></span>`}
            </p>
          </figure>
          <div class="media-content ${this.isCurrent?"current":""}">
            <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
              <a @dblclick="${this.onReload}" @click="${this.onReplay}" href="${rt("pages",this.page.url,this.page.timestamp)}">
            ...
            ${this.textSnippet?j`
              <div class="text"><keyword-mark keywords="${this.query}">${this.textSnippet}</keyword-mark></div>`:j``}
          </div>
          ${i?j`
    ...
    `)}render(){const e=`Replay of ${this.title?`${this.title}:`:""} ${this.url}`;return j`
        ...
        <div class="iframe-main modal-bg">
          <div class="panel intro-panel">
            <p class="panel-heading">
              <fa-icon id="wrlogo" size="1.5rem" .svg=${we()} aria-hidden="true"></fa-icon>
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      <thead>
        <tr class="columns results-head has-text-weight-bold">
          <th scope="col" class="column col-url is-6 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${$e}" data-key="url" class="${"url"===this.sortKey?this.sortDesc?"desc":"asc":""}">URL</a></th>
          <th scope="col" class="column col-ts is-2 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${$e}" data-key="ts" class="${"ts"===this.sortKey?this.sortDesc?"desc":"asc":""}">Date</a></th>
          <th scope="col" class="column col-mime is-3 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${$e}" data-key="mime" class="${"mime"===this.sortKey?this.sortDesc?"desc":"asc":""}">Mime Type</a></th>
          <th scope="col" class="column col-status is-1 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${$e}" data-key="status" class="${"status"===this.sortKey?this.sortDesc?"desc":"asc":""}">Status</a></th>
        </tr>
      </thead>
      ...
      ${this.sortedResults.length?this.sortedResults.map((e=>j`
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="${rt("resources",e.url,e.ts)}">
    ...
    ${this.paramString&&this.hashString&&this.inited?j`
      <iframe sandbox="${(e=>null!=e?e:N)(this.sandbox?"allow-downloads allow-modals allow-orientation-lock allow-pointer-lock         allow-popups allow-popups-to-escape-sandbox allow-presentation allow-scripts         allow-same-origin allow-forms":void 0)}"

      ...
      <div class="navbar-menu ${this.navMenuShown?"is-active":""}">
        <div class="navbar-start">
          ...
          ${pe&&!this.collInfo?O`
            ...
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${e=>window.history.forward()}" @keyup="${me}">
              <fa-icon .svg="${je.a}" aria-hidden="true"></fa-icon><span class="menu-only">&nbsp;Go Forward</span>
            </a>
          `:""}
          ${this.sourceUrl&&this.collInfo?O`
            <div class="navbar-item has-dropdown is-hoverable">
              ...
              <div class="navbar-dropdown">
                ...
                <div class="navbar-item">
                  Total Size:&nbsp;<b>${Te()(Number(this.collInfo.size||0))}</b>
                </div>
                <div class="navbar-item">
        ...
        <div class="navbar-end">
          <a href="/docs" target="_blank" class="navbar-item">
            <fa-icon .svg="${Ae.a}" aria-hidden="true"></fa-icon><span>&nbsp;User Docs</span>
          </a>
          <!--
    ...
    <section class="section no-top-padding">
      <div class="sort-header is-small">
        <button @click=${e=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?Ve.a:Fe.a}></span>
            ...
            <div class="coll-block panel-block">
              <div class="columns">
                ...
                <div class="column is-4">
                  ...
                  <a @click="${t=>this.onCopy(t,e.sourceUrl)}" class="copy"><fa-icon .svg="${Ge.a}"/></a>
                ...
                <div class="column is-2"><p class="minihead">Total Size</p>${Te()(Number(e.size||0))}
        ...
        <ul>
          ...
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${this.onHideSidebar}" @keyup="${me}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${ut.a}" aria-hidden="true"></fa-icon>
          ...
          <li class="${"story"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#story" class="is-size-6" aria-label="Story" aria-current="${"story"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${Qe.a}" aria-hidden="true" title="Story"></fa-icon></span>
          ...
          <li class="${"pages"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#pages" class="is-size-6" aria-label="Pages" aria-current="${"pages"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${rt.a}" aria-hidden="true" title="Pages"></fa-icon></span>
          ...
          <li class="${"resources"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#resources" class="is-size-6" aria-label="URLs" aria-current="${"resources"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${it.a}" aria-hidden="true" title="URLs"></fa-icon></span>
          ...
          <li class="sidebar-nav right">
            <a role="button" href="#" @click="${this.onFullPageView}" @keyup="${me}" class="is-marginless is-size-6 is-paddingless">
              ...
              <fa-icon title="Expand" .svg="${mt.a}" aria-hidden="true"></fa-icon>
            </a>
          </li>`:""}
        </ul>
      ...
      <div class="field has-addons">
        <a href="#" role="button" id="fullscreen" class="button is-borderless is-hidden-touch" @click="${this.onFullscreenToggle}" @keyup="${me}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?dt.a:lt.a}"></fa-icon>
          </span>
        </a>
        ...
        <a href="#" role="button" class="button is-borderless is-hidden-mobile" @click="${this.onGoForward}" @keyup="${me}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${je.a}"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" id="refresh" class="button is-borderless ${this.isLoading?"is-loading":"is-hidden-mobile"}" @click="${this.onRefresh}" @keyup="${me}"
          ...
          <span class="icon is-small">
            ${this.isLoading?"":O`
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${nt.a}"></fa-icon>
            `}
          </span>
        </a>
        <a href="#" role="button" class="button is-borderless is-hidden-touch ${t?"":"grey-disabled"}" @click="${this.onShowPages}" @keyup="${me}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${et.a}"></fa-icon>
          </span>
        </a>
        ...
        <div class="dropdown is-right ${this.menuActive?"is-active":""}" @click="${e=>this.menuActive=!1}">
          <div class="dropdown-trigger">
            <button class="button is-borderless" aria-haspopup="true" aria-controls="menu-dropdown" aria-expanded="${this.menuActive}" @click="${this.onMenu}"
              ...
              <span class="icon is-small">
                <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${ft.a}"></fa-icon>
              </span>
            </button>
          </div>
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              ...
              <a href="https://replayweb.page/" target="_blank" class="dropdown-item info">
                ...
                <span class="menu-version">(${"1.1.0"})</span>
              </a>
              `:""}
            </div>
          </div>
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Tt=new WeakMap,Et=w(e=>t=>{if(!(t instanceof D))throw new Error("unsafeHTML can only be used in text bindings");const i=Tt.get(t);if(void 0!==i&&_(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=e;const r=document.importNode(a.content,!0);t.setValue(r),Tt.set(t,{value:e,fragment:r})});var At=i(103),It=i.n(At);class Rt extends re{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e,t)=>{this.recalcSplitter(e[0].contentRect.width)}),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=Lt([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const t of this.collInfo.curatedPages){this.curatedPageMap[t.list]||(this.curatedPageMap[t.list]=[]);const i=e[t.page];if(!i){console.log("No Page with id: "+i);continue}const a=i.url,r=i.ts,o=i.title||i.url,n=t.desc;this.curatedPageMap[t.list].push({url:a,ts:r,title:o,desc:n})}this.scrollToList()}static get styles(){return ue(ie`
    :host {
      width: 100%;
      height: 100%;
      display: flex;
    ...
    ${Rt.sidebarStyles(te(":host(.sidebar)"))}
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?Et(It()(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return O`
    ...
    <span class="icon"><fa-icon .svg="${jt.a}"></fa-icon></span>
    ...
    `}renderContent(){switch(this.state){case"googledrive":return O`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return O`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?O`
              <p class="loaded-prog">Loaded <b>${Te()(this.currentSize)}</b> of <b>${Te()(this.totalSize)}</b></p>`:O``}
      ...
      ${Ht.sidebarStyles(te`:host(.sidebar)`)}
      ...
      <div class="dropdown ${this.menuActive?"is-active":""}">
        <div class="dropdown-trigger">
          <button @click="${this.onMenu}" class="button is-small" aria-haspopup="true" aria-expanded="${this.menuActive}" aria-controls="dropdown-menu">
            <span>Download</span>
            <span class="icon is-small">
              <fa-icon .svg="${Gt.a} aria-hidden="true"></fa-icon>
            </span>
          </button>
        </div>
    ...
    `}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",()=>{this.menuActive=!1},{once:!0})}onSort(e){e.preventDefault();const t=e.currentTarget.getAttribute("data-key")||"";t===this.sortKey?this.sortDesc=!this.sortDesc:(this.sortDesc=!1,this.sortKey=t)}onSortChanged(e){this.sortedPages=e.detail.sortedData,this.sortKey=e.detail.sortKey,this.sortDesc=e.detail.sortDesc}onSelectToggle(e){const{page:t,selected:i}=e.detail;i?this.selectedPages.add(t):this.selectedPages.delete(t),this.allSelected=this.selectedPages.size===this.sortedPages.length,this.requestUpdate()}onSelectAll(e){this.allSelected=e.currentTarget.checked,this.allSelected?this.sortedPages.forEach(e=>{this.selectedPages.add(e.id)}):this.selectedPages.clear(),this.requestUpdate()}async onDownload(e,t,i){e.preventDefault();const a=new URLSearchParams;a.set("pages",i?Array.from(this.selectedPages.keys()).join(","):"all"),a.set("format",t),this.collInfo.filename&&a.set("filename",this.collInfo.filename),window.location.href=this.collInfo.apiPrefix+"/dl?"+a.toString()}async onDeletePage(e){const t=e.currentTarget.page,i=await fetch(`${this.collInfo.apiPrefix}/page/${t.id}`,{method:"DELETE"}),a=(await i.json(),this.collInfo.pages.indexOf(t));a<0||(this.collInfo.pages.splice(a,1),this.updateTextSearch(),this.requestUpdate())}formatResults(){return 1===this.sortedPages.length?"1 Page Found":this.sortedPages.length+" Pages Found"}getNoResultsMessage(){return this.collInfo&&this.collInfo.pages.length?this.updatingSearch?"Initializing Search...":this.loading?"Searching...":this.query?O`<span class="fix-text-wrapping">No matching pages found. Try changing the search query, or <a href="#view=resources">browse by URL</a>.</span>`:"No Pages Found":O`<span class="fix-text-wrapping">No "Pages" are defined in this archive. <a href="#view=resources">Browse by URL</a>.</span>`}onScroll(e){const t=e.currentTarget;if(t.scrollHeight-t.scrollTop-t.clientHeight<40){const e=this.renderRoot.querySelector("wr-sorter");e&&e.getMore()}}}customElements.define("wr-page-view",Ht);const Ft=new RegExp(`[${["-","[","]","/","{","}","(",")","*","+","?",".","\\","^","$","|"].join("\\")}]`,"g"),Wt=e=>e.replace(Ft,"\\$&");class Vt extends HTMLElement{static get observedAttributes(){return["keywords"]}get keywords(){return this.getAttribute("keywords")||""}set keywords(e){this.setAttribute("keywords",e)}constructor(){super(),this.attachShadow({mode:"open"})}attributeChangedCallback(e,t,i){"keywords"===e&&i!==t&&this._render()}connectedCallback(){this._render(),this.__observer=new MutationObserver(()=>{this._render()}),this.__observer.observe(this,{childList:!0,characterData:!0,subtree:!0})}disconnectedCallback(){this.__observer&&(this.__observer.disconnect(),this.__observer=void 0)}_render(){if(!this.shadowRoot)return;const e=this.textContent||"",t=this.getAttribute("keywords");if(!t)return void(this.shadowRoot.textContent=e);const i=e.toLowerCase(),a=t.toLowerCase().split(/\s+/),r=new RegExp(""+a.map(Wt).join("|"),"gi"),o=e.split(r),n=document.createElement("div");let s=0;for(const t of o)if(n.appendChild(document.createTextNode(t)),s+=t.length,s<i.length){const t=i.substring(s),r=a.find(e=>t.startsWith(e));if(r){const t=document.createElement("mark");t.textContent=e.substr(s,r.length),n.appendChild(t),s+=r.length}}this.shadowRoot.innerHTML=`\n      <style>\n        mark {\n          color: var(--keyword-mark-color);\n          background: var(--keyword-mark-background, yellow);\n        }\n      </style>\n      ${n.innerHTML}\n    `}}customElements.define("keyword-mark",Vt);class Kt extends re{constructor(){super(),this.query="",this.textSnippet="",this.page=null,this.replayPrefix="",this.deleting=!1,this.editable=!1,this.iconValid=!1,this.index=0,this.isCurrent=!1,this.isSidebar=!1,this.timestamp="",this.date=null}static get properties(){return{query:{type:String},textSnippet:{type:String},page:{type:Object},replayPrefix:{type:String},deleting:{type:Boolean},selected:{type:Boolean},editable:{type:Boolean},iconValid:{type:Boolean},index:{type:Number},isCurrent:{type:Boolean},isSidebar:{type:Boolean},timestamp:{type:String},date:{type:Object}}}static get styles(){return ue(ie`
      ...
      ${Kt.sidebarStyles(te`:host(.sidebar)`)}
        ...
        <div class="media">
          ...
          <div class="media-content ${this.isCurrent?"current":""}">
            <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
              <a @click="${this.onReplay}" href="${Pe("pages",this.page.url,this.timestamp)}">
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      ...
      ${this.sortedResults.length?this.sortedResults.map(e=>O`
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="${Pe("resources",e.url,e.ts)}">${e.url}</a></td>

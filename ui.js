...
const re=new WeakMap,oe=v(e=>t=>{if(!(t instanceof L))throw new Error("unsafeSVG can only be used in text bindings");const i=re.get(t);if(void 0!==i&&$(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=`<svg>${e}</svg>`;const o=a.content,n=o.firstChild;o.removeChild(n),r(o,n.firstChild);const s=document.importNode(o,!0);t.setValue(s),re.set(t,{value:e,fragment:s})}),ne=new WeakMap,se=v(e=>t=>{if(!(t instanceof P)||t instanceof I||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=t,{style:a}=i.element;let r=ne.get(t);void 0===r&&(a.cssText=i.strings.join(" "),ne.set(t,r=new Set)),r.forEach(t=>{t in e||(r.delete(t),-1===t.indexOf("-")?a[t]=null:a.removeProperty(t))});for(const t in e)r.add(t),-1===t.indexOf("-")?a[t]=e[t]:a.setProperty(t,e[t])});var le=i(86),ce=i.n(le),de=i(50),he=i.n(de);const fe=ee(ce.a);function be(e){return[fe,e]}const ue=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches;function pe(e){" "==e.key&&(e.preventDefault(),e.target.click())}class me extends ae{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return te`
          ...
          ${this.sourceUrl&&this.collInfo?N`
            <div class="navbar-item has-dropdown is-hoverable">
              <span tabindex="0" class="info-menu navbar-link is-arrowless" aria-labelledby="about-this-archive">
                <fa-icon size="1.2em" .svg="${Ae.a}" aria-hidden="true"></fa-icon>
              ...
              <div class="navbar-dropdown">
                ...
                <div class="navbar-item">
                  Total Size:&nbsp;<b>${Pe()(Number(this.collInfo.size||0))}</b>
                </div>
                <div class="navbar-item">
  ...
  `)}render(){return N`
            ...
            <label class="file-label">
              ...
              <span class="file-cta">
                <span class="file-icon">
                  <fa-icon size="0.9em" .svg=${qe.a} aria-hidden="true"></fa-icon>
                </span>
    ...
    <section class="section no-top-padding">
      <div class="sort-header is-small">
        <button @click=${e=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?He.a:Be.a}></span>
      ...
      <div class="panel is-light">
        ...
        <div class="panel-block sort-header is-small">
          <div class="control has-icons-left">
            ...
            <span class="icon is-left is-small"><fa-icon .svg="${We.a}"/></span>
          </div>
          <wr-sorter id="index"
          sortKey="ctime"
          ?sortDesc="${!0}"
          .sortKeys="${Ve.sortKeys}"
          ...
          ${this.sortedColls.map((e,t)=>N`
            <div class="coll-block panel-block">
              <div class="columns">
                ...
                <div class="column is-2"><p class="minihead">Total Size</p>${Pe()(Number(e.size||0))}
    ...
    `}onCopy(e,t){return e.preventDefault(),e.stopPropagation(),navigator.clipboard.writeText(t),!1}}customElements.define("wr-coll-index",Ve);var Ke=i(93),Ze=i.n(Ke),Je=i(54),Ye=i.n(Je),Qe=i(94),Xe=i.n(Qe),et=i(95),tt=i.n(et),it=i(55),at=i.n(it),rt=i(56),ot=i.n(rt),nt=i(57),st=i.n(nt),lt=i(96),ct=i.n(lt),dt=i(97),ht=i.n(dt),ft=i(98),bt=i.n(ft),ut="undefined"!=typeof window?window:null,pt=null===ut,mt=pt?void 0:ut.document,gt=function(){return!1},vt=pt?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=mt.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",wt=function(e){return"string"==typeof e||e instanceof String},xt=function(e){if(wt(e)){var t=mt.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},kt=function(e,t,i){var a=e[t];return void 0!==a?a:i},yt=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},St=function(e,t){var i=mt.createElement("div");return i.className="gutter gutter-"+t,i},zt=function(e,t,i){var a={};return wt(t)?a[e]=t:a[e]=vt+"("+t+"% - "+i+"px)",a},$t=function(e,t){var i;return(i={})[e]=t+"px",i},_t=function(e,t){if(void 0===t&&(t={}),pt)return{};var i,a,r,o,n,s,l=e;Array.from&&(l=Array.from(l));var c=xt(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,h=d?d.flexDirection:null,f=kt(t,"sizes")||l.map((function(){return 100/l.length})),b=kt(t,"minSize",100),u=Array.isArray(b)?b:l.map((function(){return b})),p=kt(t,"expandToMin",!1),m=kt(t,"gutterSize",10),g=kt(t,"gutterAlign","center"),v=kt(t,"snapOffset",30),w=kt(t,"dragInterval",1),x=kt(t,"direction","horizontal"),k=kt(t,"cursor","horizontal"===x?"col-resize":"row-resize"),y=kt(t,"gutter",St),S=kt(t,"elementStyle",zt),z=kt(t,"gutterStyle",$t);function $(e,t,a,r){var o=S(i,t,a,r);Object.keys(o).forEach((function(t){e.style[t]=o[t]}))}function _(){return s.map((function(e){return e.size}))}function C(e){return"touches"in e?e.touches[0][a]:e[a]}function P(e){var t=s[this.a],i=s[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,$(t.element,t.size,this._b,t.i),$(i.element,i.size,this._c,i.i)}function L(e){var i,a=s[this.a],r=s[this.b];this.dragging&&(i=C(e)-this.start+(this._b-this.dragOffset),w>1&&(i=Math.round(i/w)*w),i<=a.minSize+v+this._b?i=a.minSize+this._b:i>=this.size-(r.minSize+v+this._c)&&(i=this.size-(r.minSize+this._c)),P.call(this,i),kt(t,"onDrag",gt)(_()))}function D(){var e=s[this.a].element,t=s[this.b].element,a=e.getBoundingClientRect(),n=t.getBoundingClientRect();this.size=a[i]+n[i]+this._b+this._c,this.start=a[r],this.end=a[o]}function T(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[n];return 0===i?null:i-="horizontal"===x?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(u.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,o){var n=t*r/100,s=yt(m,0===o,o===e.length-1,g),l=u[o]+s;return n<l?(i+=l-n,a.push(0),l):(a.push(n-l),n)}));return 0===i?e:r.map((function(e,r){var o=e;if(i>0&&a[r]-i>0){var n=Math.min(i,a[r]-i);i-=n,o=e-n}return o/t*100}))}function I(){var e=s[this.a].element,i=s[this.b].element;this.dragging&&kt(t,"onDragEnd",gt)(_()),this.dragging=!1,ut.removeEventListener("mouseup",this.stop),ut.removeEventListener("touchend",this.stop),ut.removeEventListener("touchcancel",this.stop),ut.removeEventListener("mousemove",this.move),ut.removeEventListener("touchmove",this.move),this.stop=null,this.move=null,e.removeEventListener("selectstart",gt),e.removeEventListener("dragstart",gt),i.removeEventListener("selectstart",gt),i.removeEventListener("dragstart",gt),e.style.userSelect="",e.style.webkitUserSelect="",e.style.MozUserSelect="",e.style.pointerEvents="",i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",this.gutter.style.cursor="",this.parent.style.cursor="",mt.body.style.cursor=""}function E(e){if(!("button"in e)||0===e.button){var i=s[this.a].element,a=s[this.b].element;this.dragging||kt(t,"onDragStart",gt)(_()),e.preventDefault(),this.dragging=!0,this.move=L.bind(this),this.stop=I.bind(this),ut.addEventListener("mouseup",this.stop),ut.addEventListener("touchend",this.stop),ut.addEventListener("touchcancel",this.stop),ut.addEventListener("mousemove",this.move),ut.addEventListener("touchmove",this.move),i.addEventListener("selectstart",gt),i.addEventListener("dragstart",gt),a.addEventListener("selectstart",gt),a.addEventListener("dragstart",gt),i.style.userSelect="none",i.style.webkitUserSelect="none",i.style.MozUserSelect="none",i.style.pointerEvents="none",a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",this.gutter.style.cursor=k,this.parent.style.cursor=k,mt.body.style.cursor=k,D.call(this),this.dragOffset=C(e)-this.end}}"horizontal"===x?(i="width",a="clientX",r="left",o="right",n="clientWidth"):"vertical"===x&&(i="height",a="clientY",r="top",o="bottom",n="clientHeight"),f=T(f);var U=[];function R(e){var t=e.i===U.length,i=t?U[e.i-1]:U[e.i];D.call(i);var a=t?i.size-e.minSize-i._c:e.minSize+i._b;P.call(i,a)}return(s=l.map((function(e,t){var a,r={element:xt(e),size:f[t],minSize:u[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:x,parent:c})._b=yt(m,t-1==0,!1,g),a._c=yt(m,!1,t===l.length-1,g),"row-reverse"===h||"column-reverse"===h)){var o=a.a;a.a=a.b,a.b=o}if(t>0){var n=y(t,x,r.element);!function(e,t,a){var r=z(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(n,m,t),a._a=E.bind(a),n.addEventListener("mousedown",a._a),n.addEventListener("touchstart",a._a),c.insertBefore(n,r.element),a.gutter=n}return $(r.element,r.size,yt(m,0===t,t===l.length-1,g),t),t>0&&U.push(a),r}))).forEach((function(e){var t=e.element.getBoundingClientRect()[i];t<e.minSize&&(p?R(e):e.minSize=t)})),{setSizes:function(e){var t=T(e);t.forEach((function(e,i){if(i>0){var a=U[i-1],r=s[a.a],o=s[a.b];r.size=t[i-1],o.size=e,$(r.element,r.size,a._b,r.i),$(o.element,o.size,a._c,o.i)}}))},getSizes:_,collapse:function(e){R(s[e])},destroy:function(e,t){U.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter.removeEventListener("mousedown",a._a),a.gutter.removeEventListener("touchstart",a._a)),!0!==e){var r=S(i,a.a.size,a._b);Object.keys(r).forEach((function(e){s[a.a].element.style[e]="",s[a.b].element.style[e]=""}))}}))},parent:c,pairs:U}};class Ct extends ae{constructor(){super(),this.sourceUrl=null,this.inited=!1,this.isLoading=!1,this.baseApiPrefix="./wabac/api",this.baseReplayPrefix="./wabac",this.apiPrefix="",this.replayPrefix="",this.coll="",this.collInfo=null,this._replaceLoc=!1,this._locUpdateNeeded=!1,this._locationHash="",this.tabData={},this.url="",this.ts="",this.tabNames=["pages","story","resources"],this.menuActive=!1,this.hasStory=!1,this.editable=!1,this.showSidebar="1"===localStorage.getItem("pages:showSidebar"),this.splitter=null,this.isVisible=!0,this.favIconUrl=""}static get properties(){return{inited:{type:Boolean},sourceUrl:{type:String},loadInfo:{type:Object,attribute:!1},showSidebar:{type:Boolean},collInfo:{type:Object,attribute:!1},coll:{type:String},hasStory:{type:Boolean},isLoading:{type:Boolean},tabData:{type:Object,attribute:!1},url:{type:String},ts:{type:String},isFullscreen:{type:Boolean},menuActive:{type:Boolean},embed:{type:String},editable:{type:Boolean},isVisible:{type:Boolean},favIconUrl:{type:String}}}firstUpdated(){this.inited=!0,window.addEventListener("hashchange",e=>this.onHashChange(e)),this.addEventListener("fullscreenchange",e=>{this.isFullscreen=!!document.fullscreenElement}),this.embed&&(this.observer=new IntersectionObserver((e,t)=>{this.isVisible=e[0].isIntersecting}),this.observer.observe(this))}updated(e){if(e.has("sourceUrl")&&this.doUpdateInfo(),e.has("editable")&&(this.editable?this._pollColl=setInterval(()=>this.doUpdateInfo(),1e4):this._pollColl&&clearInterval(this._pollColl)),e.has("tabData")){if(!this.collInfo||!this.collInfo.coll)return;Object.keys(this.tabData).forEach(e=>!this.tabData[e]&&delete this.tabData[e]);const t="#"+new URLSearchParams(this.tabData).toString();if(this.tabData.url||(this.url="search://"+decodeURIComponent(this._paramsToString(this.tabData))),t!==this._locationHash){if(this._locationHash=t,this._replaceLoc||0===Object.keys(e.get("tabData")).length){const e=new URL(window.location.href);e.hash=this._locationHash,window.history.replaceState({},"",e.href),this._replaceLoc=!1}else if(window.location.hash=this._locationHash,!this.showSidebar){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.focus()}this.embed&&window.parent!==window&&window.parent.postMessage(this.tabData,"*")}this._locUpdateNeeded=!1}e.has("showSidebar")&&(this.embed||localStorage.setItem("pages:showSidebar",this.showSidebar?"1":"0")),(e.has("tabData")||e.has("showSidebar"))&&this.configureSplitter()}configureSplitter(){if(this.tabData.url&&this.showSidebar){const e=this.renderRoot.querySelector("#contents"),t=this.renderRoot.querySelector("wr-coll-replay");if(e&&t&&!this.splitter){const i={sizes:[30,70],minSize:[300,300],gutterSize:4,onDragStart(){t.setDisablePointer(!0)},onDragEnd(){t.setDisablePointer(!1)}};this.splitter=_t([e,t],i)}}else if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}}async doUpdateInfo(){let e=this.loadInfo&&this.loadInfo.customColl;if(!e){e=(await _e(this.sourceUrl)).coll}this.coll=e;const t=this.baseApiPrefix+"/"+e,i=this.baseReplayPrefix+"/"+e,a=await fetch(t+"?all=1");if(200!=a.status)return void(this.collInfo={});const r=await a.json();this.collInfo={apiPrefix:t,replayPrefix:i,coll:e,...r},this.collInfo.title||(this.collInfo.title=this.collInfo.filename),"replayonly"===this.embed&&(this.showSidebar=!1),this.hasStory=this.collInfo.desc||this.collInfo.lists.length,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{collInfo:this.collInfo,alreadyLoaded:!0}})),this.onHashChange()}onCollLoaded(e){this.doUpdateInfo(),this.loadInfo=null,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{sourceUrl:this.sourceUrl,collInfo:this.collInfo}}))}onCollUpdate(e){this.editable&&(this.collInfo={...this.collInfo,...e.detail})}onHashChange(e){const t=window.location.hash;if(t&&t!==this._locationHash&&(this.tabData=Object.fromEntries(new URLSearchParams(t.slice(1)).entries()),this._locationHash=t),this.collInfo.coll&&!this.tabNames.includes(this.tabData.view)){const e=this.hasStory?"story":this.collInfo.pages.length?"pages":"resources";this.tabData={...this.tabData,view:e}}if(this.tabData.url&&this.tabData.url.startsWith("page:")){const e=Number(this.tabData.url.slice("page:".length));if(!isNaN(e)&&e<this.collInfo.pages.length){const t=this.collInfo.pages[e];this.tabData.url=t.url,this.tabData.ts=Se(t).timestamp}}this.hasStory||"story"!==this.tabData.view||(this.tabData.view="pages"),this.tabData.url&&this.tabData.query&&(this.showSidebar=!0)}onTabClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");return this.tabData={...this.tabData,view:t.slice(1)},!1}onCollTabNav(e){e.target.id===this.tabData.view||"replay"===e.target.id&&this.tabData.url?this.updateTabData(e.detail.data,e.detail.replaceLoc,!1):this.showSidebar&&this.tabData.url&&this.updateTabData(e.detail.data,e.detail.replaceLoc,!0)}updateTabData(e,t=!1,i=!1){this.tabData={...this.tabData,...e},this.tabData.url&&(this.url=this.tabData.url||""),this.tabData.ts&&(this.ts=this.tabData.ts||""),this._replaceLoc=!this._locUpdateNeeded&&t,this._locUpdateNeeded=!0}static get styles(){return be(te`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
        ...
        <ul>
          ...
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${this.onHideSidebar}" @keyup="${pe}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${ht.a}" aria-hidden="true"></fa-icon>
          ...
          <li class="${"story"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#story" class="is-size-6" aria-label="Story" aria-current="${"story"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${Ze.a}" aria-hidden="true" title="Story"></fa-icon></span>
          ...
          <li class="${"pages"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#pages" class="is-size-6" aria-label="Pages" aria-current="${"pages"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${tt.a}" aria-hidden="true" title="Pages"></fa-icon></span>
          ...
          <li class="${"resources"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#resources" class="is-size-6" aria-label="URLs" aria-current="${"resources"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${Xe.a}" aria-hidden="true" title="URLs"></fa-icon></span>
          ...
          <li class="sidebar-nav right">
            <a role="button" href="#" @click="${this.onFullPageView}" @keyup="${pe}" class="is-marginless is-size-6 is-paddingless">
              ...
              <fa-icon title="Expand" .svg="${bt.a}" aria-hidden="true"></fa-icon>
            </a>
          </li>`:""}
        </ul>
      ...
      <div class="field has-addons">
        <a href="#" role="button" id="fullscreen" class="button is-borderless is-hidden-touch" @click="${this.onFullscreenToggle}" @keyup="${pe}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?st.a:ot.a}"></fa-icon>
          </span>
        </a>
        ...
        <a href="#" role="button" id="refresh" class="button is-borderless ${this.isLoading?"is-loading":"is-hidden-mobile"}" @click="${this.onRefresh}" @keyup="${pe}"
          ...
          <span class="icon is-small">
            ${this.isLoading?"":N`
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${at.a}"></fa-icon>
            `}
          </span>
        </a>
        <a href="#" role="button" class="button is-borderless is-hidden-touch ${t?"":"grey-disabled"}" @click="${this.onShowPages}" @keyup="${pe}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Ye.a}"></fa-icon>
          </span>
        </a>
    ...
    </nav><p id="skip-replay-target" tabindex="-1" class="is-sr-only">Skipped</p>`}dragStart(e){const t=this.renderRoot.querySelector("wr-coll-replay");t&&t.setDisablePointer(!0)}dragEnd(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!1)}renderCollTabs(e){const t=this.hasStory&&"story"===this.tabData.view,i="pages"===this.tabData.view,a="resources"===this.tabData.view;return N`
    ${t?N`
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Pt=new WeakMap,Lt=v(e=>t=>{if(!(t instanceof L))throw new Error("unsafeHTML can only be used in text bindings");const i=Pt.get(t);if(void 0!==i&&$(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=e;const r=document.importNode(a.content,!0);t.setValue(r),Pt.set(t,{value:e,fragment:r})});var Dt=i(99),Tt=i.n(Dt);class It extends ae{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e,t)=>{this.recalcSplitter(e[0].contentRect.width)}),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=_t([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const t of this.collInfo.curatedPages){this.curatedPageMap[t.list]||(this.curatedPageMap[t.list]=[]);const i=e[t.page];if(!i){console.log("No Page with id: "+i);continue}const a=i.url,r=i.ts,o=i.title||i.url,n=t.desc;this.curatedPageMap[t.list].push({url:a,ts:r,title:o,desc:n})}this.scrollToList()}static get styles(){return be(te`
    :host {
      width: 100%;
      height: 100%;
      display: flex;
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?Lt(Tt()(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return N`
    ...
    `)}`}renderCPage(e){const t=new Date(e.ts),i=ze(t.toISOString());return N`
    <li>
      <div class="content">
        <a @click="${this.onReplay}" data-url="${e.url}" data-ts="${i}"
          href="${$e("story",e.url,i)}">
    ...
    `}renderContent(){switch(this.state){case"googledrive":return N`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return N`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?N`
              <p class="loaded-prog">Loaded <b>${Pe()(this.currentSize)}</b> of <b>${Pe()(this.totalSize)}</b></p>`:N``}
    ...
    <div class="search-bar notification is-marginless">
      ...
      <div class="field flex-auto">
        <div class="control has-icons-left ${this.loading?"is-loading":""}">
          ...
          <span class="icon is-left"><fa-icon .svg="${We.a}" aria-hidden="true"></fa-icon></span>
        </div>
      </div>
    </div>
    <div class="main columns">
      <div class="column index-bar is-one-fifth is-hidden-mobile">
        ...
        ${this.editable?N`<fa-icon class="editIcon" .svg="${Bt.a}"></fa-icon>`:N``}
    ...
    `}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=ze(e.date):"string"==typeof e.ts&&(t=ze(e.ts)),t===this.ts}return!1}renderPages(){return N`
        ...
        <div class="media">
          ...
          <div class="media-content ${this.isCurrent?"current":""}">
            <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
              <a @click="${this.onReplay}" href="${$e("pages",this.page.url,this.page.timestamp)}">
        ...
        <div class="level-item flex-auto">
          ...
          <div class="field flex-auto">
            <div class="control has-icons-left ${this.loading?"is-loading":""}">
              ...
              <span class="icon is-left"><fa-icon .svg="${We.a}"/></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      ...
      ${this.sortedResults.length?this.sortedResults.map(e=>N`
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="${$e("resources",e.url,e.ts)}">

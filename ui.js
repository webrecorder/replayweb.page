 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,a){const r=t[0];if("."===r){return new E(e,t.slice(1),i).parts}return"@"===r?[new R(e,t.slice(1),a.eventContext)]:"?"===r?[new T(e,t.slice(1),i)]:new C(e,t,i).parts}handleTextExpression(e){return new D(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const oe=new WeakMap,ne=w(e=>t=>{if(!(t instanceof D))throw new Error("unsafeSVG can only be used in text bindings");const i=oe.get(t);if(void 0!==i&&_(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=`<svg>${e}</svg>`;const o=a.content,n=o.firstChild;o.removeChild(n),r(o,n.firstChild);const s=document.importNode(o,!0);t.setValue(s),oe.set(t,{value:e,fragment:s})}),se=new WeakMap,le=w(e=>t=>{if(!(t instanceof L)||t instanceof A||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=t,{style:a}=i.element;let r=se.get(t);void 0===r&&(a.cssText=i.strings.join(" "),se.set(t,r=new Set)),r.forEach(t=>{t in e||(r.delete(t),-1===t.indexOf("-")?a[t]=null:a.removeProperty(t))});for(const t in e)r.add(t),-1===t.indexOf("-")?a[t]=e[t]:a.setProperty(t,e[t])});var ce=i(90),de=i.n(ce),he=i(53),fe=i.n(he);const be=te(de.a);function ue(e){return[be,e]}const pe=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches;class me extends re{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return ie`
    :host {
    ...
    `}render(){if(!this.svg)return N``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),N`<svg style="${le(e)}"><g>${ne(this.svg)}</g></svg>`}}customElements.define("fa-icon",me),customElements.define("wr-anim-logo",class extends me{constructor(){super(),this.svg=fe.a}static get styles(){return ie`
    #wrlogo #stop5687 {
    ...
    `)}render(){return this.inited?N`
    ${this.embed&&"full"!==this.embed?"":N`
      ...
      <div class="navbar-brand">
        ${this.embed?N`
          <span class="navbar-item wr-logo-item">
            <fa-icon id="wrlogo" size="2.5rem" .svg=${fe.a} aria-hidden="true"></fa-icon>
          </span>
        `:N`
      ...
      <div class="navbar-menu ${this.navMenuShown?"is-active":""}">
        <div class="navbar-start">
          ...
          ${pe&&!this.collInfo?N`
            <a class="navbar-item arrow-button" title="Go Back" @click="${e=>window.history.back()}">
              <fa-icon .svg="${Ae.a}" aria-hidden="true"></fa-icon><span class="menu-only">&nbsp;Go Back</span>
            </a>
            <a class="navbar-item arrow-button" title="Go Forward" @click="${e=>window.history.forward()}">
              <fa-icon .svg="${Re.a}" aria-hidden="true"></fa-icon><span class="menu-only">&nbsp;Go Forward</span>
            </a>
          `:""}
          ${this.sourceUrl&&this.collInfo?N`
            <div class="navbar-item has-dropdown is-hoverable">
              <span tabindex="0" class="info-menu navbar-link is-arrowless" aria-labelledby="about-this-archive">
                <fa-icon size="1.2em" .svg="${je.a}" aria-hidden="true"></fa-icon>
        ...
        <div class="navbar-end">
          <a href="/docs" target="_blank" class="navbar-item">
            <fa-icon .svg="${Te.a}" aria-hidden="true"></fa-icon><span>&nbsp;User Docs</span>
          </a>
          <!--
    ...
    `:""} `:N``}firstUpdated(){this.initRoute(),window.addEventListener("popstate",e=>{this.initRoute()})}updated(e){e.has("sourceUrl")&&(this.collInfo=null)}onFavIcons(e){const t=document.querySelector("head"),i=document.querySelectorAll("link[rel*='icon']");for(const e of i)t.removeChild(e);for(const i of e.detail.icons){const e=document.createElement("link");e.rel=i.rel,e.href=i.href,t.appendChild(e)}}skipMenu(e){e.preventDefault(),this.renderRoot.querySelector("#skip-main-target").focus()}clickOnSpacebarPress(e){" "==e.key&&(e.preventDefault(),e.target.click())}onNavMenu(e){e.preventDefault(),e.stopPropagation(),this.navMenuShown=!this.navMenuShown,this.navMenuShown&&(document.addEventListener("click",e=>{e.preventDefault(),this.navMenuShown=!1,this.renderRoot.querySelector("#menu-button").focus()},{once:!0}),document.addEventListener("keypress",e=>{"Escape"==e.key&&(e.preventDefault(),this.navMenuShown=!1,this.renderRoot.querySelector("#menu-button").focus())},{once:!0}))}initRoute(){this.inited=!0,this.pageParams=new URLSearchParams(window.location.search);let e=this.pageParams.get("state");if(e)try{if(e=JSON.parse(e),e.ids instanceof Array&&e.userId&&"open"===e.action)return this.pageParams.set("source","googledrive://"+e.ids[0]),this.pageParams.delete("state"),void(window.location.search=this.pageParams.toString())}catch(e){console.log(e)}if(this.sourceUrl=this.pageParams.get("source")||"",this.embed=this.pageParams.get("embed")||"",this.pageParams.has("terms")&&(this.showTerms=!0),this.pageParams.get("config")){this.loadInfo||(this.loadInfo={});try{this.loadInfo.extraConfig=JSON.parse(this.pageParams.get("config"))}catch(e){console.log("invalid config: "+e)}}this.pageParams.get("basePageUrl")&&(this.loadInfo||(this.loadInfo={extraConfig:{}}),this.loadInfo.extraConfig||(this.loadInfo.extraConfig={}),this.loadInfo.extraConfig.baseUrl=this.pageParams.get("basePageUrl")),this.pageParams.get("customColl")&&(this.loadInfo||(this.loadInfo={}),this.loadInfo.customColl=this.pageParams.get("customColl"))}onStartLoad(e){if(this.pageParams.set("source",e.detail.sourceUrl),e.detail.isFile){{const e=new URL(window.location.href);e.search=this.pageParams.toString(),window.history.pushState({},"",e.toString())}this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail}else window.location.search=this.pageParams.toString()}onCollLoaded(e){this.loadInfo=null,e.detail.collInfo&&(this.collInfo=e.detail.collInfo),e.detail.alreadyLoaded||e.detail.sourceUrl!==this.sourceUrl&&(this.pageParams.set("source",e.detail.sourceUrl),window.location.search=this.pageParams.toString())}});var Me=i(93),Oe=i.n(Me);customElements.define("wr-chooser",class extends re{constructor(){super(),this.fileDisplayName="",this.file=null}onChooseFile(e){0!==e.currentTarget.files.length&&(this.file=e.currentTarget.files[0],this.fileDisplayName="file://"+(this.file.path||this.file.name),this.requestUpdate())}onStartLoad(e){e.preventDefault();const t={sourceUrl:this.fileDisplayName};if(this.file){if(t.isFile=!0,this.file.path){const e=new URL("http://files.replayweb.page/");e.searchParams.set("filename",this.file.path),t.loadUrl=e.href}else t.loadUrl=URL.createObjectURL(this.file),t.blob=this.file;t.size=this.file.size,t.noCache=void 0!==this.file.path,t.name=this.fileDisplayName}return this.dispatchEvent(new CustomEvent("load-start",{detail:t})),!1}onInput(e){this.fileDisplayName=e.currentTarget.value,this.file&&this.fileDisplayName&&this.fileDisplayName.startsWith("file://")&&(this.file=null,this.fileDisplayName="")}static get styles(){return ue(ie`
    :host {
      min-width: 0;
    }
    .extra-padding {
  ...
  `)}render(){return N`
            ...
            <label class="file-label">
              ...
              <span class="file-cta">
                <span class="file-icon">
                  <fa-icon size="0.9em" .svg=${Oe.a} aria-hidden="true"></fa-icon>
                </span>
            ...
            <div class="coll-block panel-block">
              <div class="columns">
                ...
                <div class="column is-4">
                  ...
                  <a @click="${t=>this.onCopy(t,e.sourceUrl)}" class="copy"><fa-icon .svg="${Ne.a}"/></a>
                  ${e.sourceUrl&&e.sourceUrl.startsWith("googledrive://")?N`
                    <p><i>(${e.filename})</i></p>`:""}
                </div>
              ...
              ${this._deleting[e.sourceUrl]?N`
              <span class="button delete is-loading is-static">Deleting</span`:N`
    ...
    `}render(){if(!this.inited)return N``;const e=!!this.tabData.url,t=e&&this.showSidebar;return this.collInfo&&!this.collInfo.coll?N`
      <wr-loader .loadInfo="${this.loadInfo}" embed="${this.embed}"
      .coll="${this.coll}" .sourceUrl="${this.sourceUrl}" @coll-loaded=${this.onCollLoaded}></wr-loader>`:this.collInfo?N`
        ...
        <ul>
          ...
          <li class="sidebar-nav left">
            <a @click="${this.onHideSidebar}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${ft.a}"></fa-icon>
          ...
          <li class="${"story"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#story" class="is-size-6" aria-label="Story" aria-current="${"story"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${Je.a}" aria-hidden="true" title="Story"></fa-icon></span>
          ...
          <li class="${"pages"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#pages" class="is-size-6" aria-label="Pages" aria-current="${"pages"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${it.a}" aria-hidden="true" title="Pages"></fa-icon></span>
          ...
          <li class="${"resources"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#resources" class="is-size-6" aria-label="URLs" aria-current="${"resources"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${et.a}" aria-hidden="true" title="URLs"></fa-icon></span>
          ...
          <li class="sidebar-nav right">
            <a @click="${this.onFullPageView}" class="is-marginless is-size-6 is-paddingless">
              ...
              <fa-icon title="Expand" .svg="${ut.a}" aria-hidden="true"></fa-icon>
            </a>
          </li>`:""}
        </ul>
      </nav>`}renderLocationBar(){if("replayonly"===this.embed)return"";const e=function(e){if(!e)return"";e.length<14&&(e+="00000000000000".substr(e.length));const t=e.substring(0,4)+"-"+e.substring(4,6)+"-"+e.substring(6,8)+"T"+e.substring(8,10)+":"+e.substring(10,12)+":"+e.substring(12,14)+"-00:00";return new Date(t)}(this.ts).toLocaleString(),t=!!this.tabData.url;return N`
      ...
      <div class="field has-addons">
        <button id="fullscreen" class="button is-borderless is-hidden-touch" @click="${this.onFullscreenToggle}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?lt.a:nt.a}"></fa-icon>
          </span>
        </button>
        ...
        <button class="button is-borderless is-hidden-mobile" @click="${this.onGoForward}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Re.a}"></fa-icon>
          </span>
        </button>
        <button id="refresh" class="button is-borderless ${this.isLoading?"is-loading":"is-hidden-mobile"}" @click="${this.onRefresh}"
          ...
          <span class="icon is-small">
            ${this.isLoading?"":N`
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${rt.a}"></fa-icon>
            `}
          </span>
        </button>
        <button class="button is-borderless is-hidden-touch ${t?"":"grey-disabled"}" @click="${this.onShowPages}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Qe.a}"></fa-icon>
          </span>
        </button>
        <form @submit="${this.onSubmit}">
          <div class="control is-expanded">
            ...
            ${t?N`<p id="datetime" class="control is-hidden-mobile">${e}</p>`:N``}
          </div>
        </form>
        ...
        <div class="dropdown is-right ${this.menuActive?"is-active":""}" @click="${e=>this.menuActive=!1}">
          <div class="dropdown-trigger">
            <button class="button is-borderless" aria-haspopup="true" aria-controls="menu-dropdown" aria-expanded="${this.menuActive}" @click="${this.onMenu}"
              ...
              <span class="icon is-small">
                <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${dt.a}"></fa-icon>
              </span>
            </button>
          </div>
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              ...
              <a href="#" role="button" class="dropdown-item is-hidden-tablet has-text-grey" @click="${this.onRefresh}" @keyup="${this.clickOnSpacebarPress}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="" aria-hidden="true" .svg="${rt.a}"></fa-icon>
                </span>
                <span>Reload</span>
              </a>
              <a href="#" role="button" class="dropdown-item is-hidden-desktop ${t?"":"grey-disabled"}" @click="${this.onShowPages}" @keyup="${this.clickOnSpacebarPress}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="" aria-hidden="true" .svg="${Qe.a}"></fa-icon>
                </span>
              ...
              <a href="https://replayweb.page/" target="_blank" class="dropdown-item info">
                <fa-icon class="menu-logo" size="1.0rem" aria-hidden="true" .svg=${fe.a}></fa-icon>
    ...
    </nav><p id="skip-replay-target" tabindex="-1" class="is-sr-only">Skipped</p>`}dragStart(e){const t=this.renderRoot.querySelector("wr-coll-replay");t&&t.setDisablePointer(!0)}dragEnd(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!1)}renderCollTabs(e){const t="story"===this.tabData.view,i="pages"===this.tabData.view,a="resources"===this.tabData.view;return N`
    ${this.hasStory?N`
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Lt=new WeakMap,Dt=w(e=>t=>{if(!(t instanceof D))throw new Error("unsafeHTML can only be used in text bindings");const i=Lt.get(t);if(void 0!==i&&_(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=e;const r=document.importNode(a.content,!0);t.setValue(r),Lt.set(t,{value:e,fragment:r})});var Tt=i(103),Et=i.n(Tt);class At extends re{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e,t)=>{this.recalcSplitter(e[0].contentRect.width)}),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=Pt([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const t of this.collInfo.curatedPages){this.curatedPageMap[t.list]||(this.curatedPageMap[t.list]=[]);const i=e[t.page];if(!i){console.log("No Page with id: "+i);continue}const a=i.url,r=i.ts,o=i.title||i.url,n=t.desc;this.curatedPageMap[t.list].push({url:a,ts:r,title:o,desc:n})}this.scrollToList()}static get styles(){return ue(ie`
    :host {
      width: 100%;
      height: 100%;
      display: flex;
    ...
    ${e} .menu {
      font-size: 0.80rem;
    }`}render(){const e=this.currList;return N`
    <div id="story-heading" class="is-sr-only" role="heading" aria-level="${this.isSidebar?"2":"1"}">
    ...
    <div class="columns">
        ...
        <aside class="menu">
          <ul class="menu-list">
            <li>
              ...
              <ul class="menu-list">${this.collInfo.lists.map(t=>N`
                <li>
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?Dt(Et()(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return N`
    ${this.collInfo.lists.map((e,t)=>N`
    <article id="list-${e.id}">
      <div class="content">
        ...
        <p>${e.desc}</p>
        <ol>
          ${this.curatedPageMap[e.id]?this.curatedPageMap[e.id].map(e=>this.renderCPage(e)):N``}
        </ol>
      </div>
    </article>
    `)}`}renderCPage(e){const t=new Date(e.ts);return N`
    <li>
      <div class="content">
    ...
    `}renderContent(){switch(this.state){case"googledrive":return N`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return N`
    ...
    ${e} .menu {
      font-size: 0.80rem;
    }`}onSelectList(e){e.preventDefault(),this.currList=Number(e.currentTarget.getAttribute("data-list"))}onSelectListDrop(e){e.preventDefault(),this.currList=Number(e.currentTarget.value)}render(){const e=this.currList;return N`
    ...
    <div class="search-bar notification is-marginless">
      ${this.isSidebar?N`<h3 class="is-sr-only">Search and Filter Pages</h3>`:""}
    ...
    </div>`}renderDownloadMenu(){return N`
      <div class="dropdown ${this.menuActive?"is-active":""}">
        <div class="dropdown-trigger">
          <button @click="${this.onMenu}" class="button is-small" aria-haspopup="true" aria-expanded="${this.menuActive}" aria-controls="dropdown-menu">
            <span>Download</span>
            <span class="icon is-small">
              <fa-icon .svg="${Nt.a} aria-hidden="true"></fa-icon>
            </span>
          </button>
        </div>
        <div class="dropdown-menu" id="dropdown-menu">
          <div class="dropdown-content">
            <a role="button" href="#" @click="${e=>this.onDownload(e,"wacz",!0)}" @keyup="${this.clickOnSpacebarPress}" class="dropdown-item">
              Download Selected as WACZ (Web Archive Collection)
            </a>
            <a role="button" href="#" @click="${e=>this.onDownload(e,"warc",!0)}" @keyup="${this.clickOnSpacebarPress}" class="dropdown-item">
              Download Selected as WARC Only
            </a>
            <hr class="dropdown-divider">
            <a role="button" href="#" @click="${e=>this.onDownload(e,"wacz",!1)}" @keyup="${this.clickOnSpacebarPress}" class="dropdown-item">
              Download All as WACZ (Web Archive Collection)
            </a>
            <a role="button" href="#" @click="${e=>this.onDownload(e,"warc",!1)}" @keyup="${this.clickOnSpacebarPress}" class="dropdown-item">
              Download All as WARC Only
            </a>
          </div>
        </div>
      </div>`}renderPageHeader(){return N`
    ${this.editable?N`
    ...
    <div class="header columns is-hidden-mobile">
      ...
      <a role="button" href="#" @click="${this.onSort}" @keyup="${this.clickOnSpacebarPress}" data-key="ts" class="column is-2 ${"ts"===this.sortKey?this.sortDesc?"desc":"asc":""}">Date</a>
      <a role="button" href="#" @click="${this.onSort}" @keyup="${this.clickOnSpacebarPress}" data-key="title" class="column is-6 pagetitle ${"title"===this.sortKey?this.sortDesc?"desc":"asc":""}">Page Title</a>
    </div>
    ...
    `}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=_e(e.date):"string"==typeof e.ts&&(t=_e(e.ts)),t===this.ts}return!!this.editable&&this.selectedPages.has(p.id)}renderPages(){return N`
      <div class="page-header has-text-weight-bold">
      ${this.renderPageHeader()}
      </div>
      <ul class="scroller" @scroll="${this.onScroll}">
        ${this.sortedPages.length?N`
          ${this.sortedPages.map((e,t)=>{const i=this.isCurrPage(e);return N`
          <li class="content ${i?"current":""}">
            <wr-page-entry
    ...
    `}updated(e){if(e.has("page")||e.has("query")){this.updateSnippet(),this.iconValid=!!this.page.favIconUrl,this.deleting=!1;const e=$e(this.page);this.timestamp=e.timestamp,this.date=e.date}}render(){const e=this.page,t=this.date,i="number"==typeof e.size;return N`
    ${this.editable?N`
    <div class="check-select">
      <label class="checkbox">
      ...
      <div class="column">
        <div class="media">
          <figure class="media-left">
            <p class="">
            ${this.iconValid?N`
              <img class="favicon" @error="${e=>this.iconValid=!1}" src="${this.replayPrefix}/${this.timestamp}id_/${e.favIconUrl}"/>`:N`
          ...
          <div class="media-content ${this.isCurrent?"current":""}">
            ...
            ${this.isCurrent?N`<p class="curr-page is-pulled-right">Current Page</p>`:""}
            ...
            ${this.textSnippet?N`
              <div class="text"><keyword-mark keywords="${this.query}">${this.textSnippet}</keyword-mark></div>`:N``}
          </div>
          ${i?N`
    ...
    <table class="all-results" aria-labelledby="url-heading num-results">
      <thead>
        <tr class="columns results-head has-text-weight-bold">
          <th scope="col" class="column col-url is-6 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${this.clickOnSpacebarPress}" data-key="url" class="${"url"===this.sortKey?this.sortDesc?"desc":"asc":""}">URL</a></th>
          <th scope="col" class="column col-ts is-2 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${this.clickOnSpacebarPress}" data-key="ts" class="${"ts"===this.sortKey?this.sortDesc?"desc":"asc":""}">Date</a></th>
          <th scope="col" class="column col-mime is-3 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${this.clickOnSpacebarPress}" data-key="mime" class="${"mime"===this.sortKey?this.sortDesc?"desc":"asc":""}">Mime Type</a></th>
          <th scope="col" class="column col-status is-1 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${this.clickOnSpacebarPress}" data-key="status" class="${"status"===this.sortKey?this.sortDesc?"desc":"asc":""}">Status</a></th>
        </tr>
      </thead>

      <tbody class="main-scroll" @scroll="${this.onScroll}">
      ${this.sortedResults.length?this.sortedResults.map(e=>N`
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="#">${e.url}</a></td>
    ...
    `)}render(){return N`
    ${this.paramString&&this.hashString&&this.swInited?N`

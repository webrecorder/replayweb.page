          ...
          ${this.sourceUrl&&this.collInfo?N`
            <div class="navbar-item has-dropdown is-hoverable">
              ...
              <div class="navbar-dropdown">
                ...
                <hr class="navbar-divider">
                <div class="navbar-item">
                  ReplayWeb.page Version: ${"1.1.2-beta.0"}
                </div>
              </div>
            </div>
            `:""}
          ...
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              ...
              <a href="https://replayweb.page/" target="_blank" class="dropdown-item info">
                ...
                <span class="menu-version">(${"1.1.2-beta.0"})</span>
              </a>
              `:""}
            </div>
          </div>
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Dt=new WeakMap,Tt=v(e=>t=>{if(!(t instanceof L))throw new Error("unsafeHTML can only be used in text bindings");const i=Dt.get(t);if(void 0!==i&&$(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=e;const r=document.importNode(a.content,!0);t.setValue(r),Dt.set(t,{value:e,fragment:r})});var Et=i(106),It=i.n(Et);class At extends ae{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e,t)=>{this.recalcSplitter(e[0].contentRect.width)}),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=Pt([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const t of this.collInfo.curatedPages){this.curatedPageMap[t.list]||(this.curatedPageMap[t.list]=[]);const i=e[t.page];if(!i){console.log("No Page with id: "+i);continue}const a=i.url,r=i.ts,o=i.title||i.url,n=t.desc;this.curatedPageMap[t.list].push({url:a,ts:r,title:o,desc:n})}this.scrollToList()}static get styles(){return be(te`
    :host {
      width: 100%;
      height: 100%;
      display: flex;

...
`,us=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),fs=class extends Pr{constructor(){super(...arguments),this.hasSlotController=new ds(this,"icon","suffix"),this.localize=new cs(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout((()=>this.hide()),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await Zr(this.base),this.base.hidden=!1;const{keyframes:e,options:t}=Vr(this,"alert.show",{dir:this.localize.dir()});await Kr(this.base,e,t),this.emit("sl-after-show")}else{this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),await Zr(this.base);const{keyframes:e,options:t}=Vr(this,"alert.hide",{dir:this.localize.dir()});await Kr(this.base,e,t),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Gr(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Gr(this,"sl-after-hide")}async toast(){return new Promise((e=>{null===us.parentElement&&document.body.append(us),us.appendChild(this),requestAnimationFrame((()=>{this.clientWidth,this.show()})),this.addEventListener("sl-after-hide",(()=>{us.removeChild(this),e(),null===us.querySelector("sl-alert")&&us.remove()}),{once:!0})}))}render(){return Q`
      <div
        part="base"
...
`,ms=class extends Pr{constructor(){super(...arguments),this.localize=new cs(this)}render(){return Q`

 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var p;u.finalized=!0,u.elementProperties=new Map,u.elementStyles=[],u.shadowRootOptions={mode:"open"},null==c||c({ReactiveElement:u}),(null!==(s=globalThis.reactiveElementVersions)&&void 0!==s?s:globalThis.reactiveElementVersions=[]).push("1.1.1");const m=globalThis.trustedTypes,g=m?m.createPolicy("lit-html",{createHTML:e=>e}):void 0,v=`lit$${(Math.random()+"").slice(9)}$`,w="?"+v,x=`<${w}>`,k=document,y=(e="")=>k.createComment(e),_=e=>null===e||"object"!=typeof e&&"function"!=typeof e,$=Array.isArray,S=e=>{var t;return $(e)||"function"==typeof(null===(t=e)||void 0===t?void 0:t[Symbol.iterator])},z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,C=/-->/g,A=/>/g,D=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,E=/'/g,I=/"/g,L=/^(?:script|style|textarea)$/i,T=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),P=T(1),U=(T(2),Symbol.for("lit-noChange")),R=Symbol.for("lit-nothing"),q=new WeakMap,M=k.createTreeWalker(k,129,null,!1),F=(e,t)=>{const i=e.length-1,a=[];let r,o=2===t?"<svg>":"",n=z;for(let t=0;t<i;t++){const i=e[t];let s,l,d=-1,c=0;for(;c<i.length&&(n.lastIndex=c,l=n.exec(i),null!==l);)c=n.lastIndex,n===z?"!--"===l[1]?n=C:void 0!==l[1]?n=A:void 0!==l[2]?(L.test(l[2])&&(r=RegExp("</"+l[2],"g")),n=D):void 0!==l[3]&&(n=D):n===D?">"===l[0]?(n=null!=r?r:z,d=-1):void 0===l[1]?d=-2:(d=n.lastIndex-l[2].length,s=l[1],n=void 0===l[3]?D:'"'===l[3]?I:E):n===I||n===E?n=D:n===C||n===A?n=z:(n=D,r=void 0);const h=n===D&&e[t+1].startsWith("/>")?" ":"";o+=n===z?i+x:d>=0?(a.push(s),i.slice(0,d)+"$lit$"+i.slice(d)+v+h):i+v+(-2===d?(a.push(void 0),t):h)}const s=o+(e[i]||"<?>")+(2===t?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==g?g.createHTML(s):s,a]};class O{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let r=0,o=0;const n=e.length-1,s=this.parts,[l,d]=F(e,t);if(this.el=O.createElement(l,i),M.currentNode=this.el.content,2===t){const e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;null!==(a=M.nextNode())&&s.length<n;){if(1===a.nodeType){if(a.hasAttributes()){const e=[];for(const t of a.getAttributeNames())if(t.endsWith("$lit$")||t.startsWith(v)){const i=d[o++];if(e.push(t),void 0!==i){const e=a.getAttribute(i.toLowerCase()+"$lit$").split(v),t=/([.?@])?(.*)/.exec(i);s.push({type:1,index:r,name:t[2],strings:e,ctor:"."===t[1]?W:"?"===t[1]?K:"@"===t[1]?V:N})}else s.push({type:6,index:r})}for(const t of e)a.removeAttribute(t)}if(L.test(a.tagName)){const e=a.textContent.split(v),t=e.length-1;if(t>0){a.textContent=m?m.emptyScript:"";for(let i=0;i<t;i++)a.append(e[i],y()),M.nextNode(),s.push({type:2,index:++r});a.append(e[t],y())}}}else if(8===a.nodeType)if(a.data===w)s.push({type:2,index:r});else{let e=-1;for(;-1!==(e=a.data.indexOf(v,e+1));)s.push({type:7,index:r}),e+=v.length-1}r++}}static createElement(e,t){const i=k.createElement("template");return i.innerHTML=e,i}}function j(e,t,i=e,a){var r,o,n,s;if(t===U)return t;let l=void 0!==a?null===(r=i._$Cl)||void 0===r?void 0:r[a]:i._$Cu;const d=_(t)?void 0:t._$litDirective$;return(null==l?void 0:l.constructor)!==d&&(null===(o=null==l?void 0:l._$AO)||void 0===o||o.call(l,!1),void 0===d?l=void 0:(l=new d(e),l._$AT(e,i,a)),void 0!==a?(null!==(n=(s=i)._$Cl)&&void 0!==n?n:s._$Cl=[])[a]=l:i._$Cu=l),void 0!==l&&(t=j(e,l._$AS(e,t.values),l,a)),t}class B{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,r=(null!==(t=null==e?void 0:e.creationScope)&&void 0!==t?t:k).importNode(i,!0);M.currentNode=r;let o=M.nextNode(),n=0,s=0,l=a[0];for(;void 0!==l;){if(n===l.index){let t;2===l.type?t=new H(o,o.nextSibling,this,e):1===l.type?t=new l.ctor(o,l.name,l.strings,this,e):6===l.type&&(t=new Z(o,this,e)),this.v.push(t),l=a[++s]}n!==(null==l?void 0:l.index)&&(o=M.nextNode(),n++)}return r}m(e){let t=0;for(const i of this.v)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class H{constructor(e,t,i,a){var r;this.type=2,this._$AH=R,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=null===(r=null==a?void 0:a.isConnected)||void 0===r||r}get _$AU(){var e,t;return null!==(t=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==t?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=j(this,e,t),_(e)?e===R||null==e||""===e?(this._$AH!==R&&this._$AR(),this._$AH=R):e!==this._$AH&&e!==U&&this.$(e):void 0!==e._$litType$?this.T(e):void 0!==e.nodeType?this.S(e):S(e)?this.A(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}S(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==R&&_(this._$AH)?this._$AA.nextSibling.data=e:this.S(k.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,r="number"==typeof a?this._$AC(e):(void 0===a.el&&(a.el=O.createElement(a.h,this.options)),a);if((null===(t=this._$AH)||void 0===t?void 0:t._$AD)===r)this._$AH.m(i);else{const e=new B(r,this),t=e.p(this.options);e.m(i),this.S(t),this._$AH=e}}_$AC(e){let t=q.get(e.strings);return void 0===t&&q.set(e.strings,t=new O(e)),t}A(e){$(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const r of e)a===t.length?t.push(i=new H(this.M(y()),this.M(y()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;void 0===this._$AM&&(this._$Cg=e,null===(t=this._$AP)||void 0===t||t.call(this,e))}}class N{constructor(e,t,i,a,r){this.type=1,this._$AH=R,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=R}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const r=this.strings;let o=!1;if(void 0===r)e=j(this,e,t,0),o=!_(e)||e!==this._$AH&&e!==U,o&&(this._$AH=e);else{const a=e;let n,s;for(e=r[0],n=0;n<r.length-1;n++)s=j(this,a[i+n],t,n),s===U&&(s=this._$AH[n]),o||(o=!_(s)||s!==this._$AH[n]),s===R?e=R:e!==R&&(e+=(null!=s?s:"")+r[n+1]),this._$AH[n]=s}o&&!a&&this.k(e)}k(e){e===R?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class W extends N{constructor(){super(...arguments),this.type=3}k(e){this.element[this.name]=e===R?void 0:e}}const G=m?m.emptyScript:"";class K extends N{constructor(){super(...arguments),this.type=4}k(e){e&&e!==R?this.element.setAttribute(this.name,G):this.element.removeAttribute(this.name)}}class V extends N{constructor(e,t,i,a,r){super(e,t,i,a,r),this.type=5}_$AI(e,t=this){var i;if((e=null!==(i=j(this,e,t,0))&&void 0!==i?i:R)===U)return;const a=this._$AH,r=e===R&&a!==R||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,o=e!==R&&(a===R||r);r&&this.element.removeEventListener(this.name,this,a),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(t=this.options)||void 0===t?void 0:t.host)&&void 0!==i?i:this.element,e):this._$AH.handleEvent(e)}}class Z{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){j(this,e)}}const Q=window.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var J,Y;null==Q||Q(O,H),(null!==(p=globalThis.litHtmlVersions)&&void 0!==p?p:globalThis.litHtmlVersions=[]).push("2.1.1");class X extends u{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return null!==(e=(t=this.renderOptions).renderBefore)&&void 0!==e||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=((e,t,i)=>{var a,r;const o=null!==(a=null==i?void 0:i.renderBefore)&&void 0!==a?a:t;let n=o._$litPart$;if(void 0===n){const e=null!==(r=null==i?void 0:i.renderBefore)&&void 0!==r?r:null;o._$litPart$=n=new H(t.insertBefore(y(),e),e,void 0,null!=i?i:{})}return n._$AI(e),n})(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),null===(e=this._$Dt)||void 0===e||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._$Dt)||void 0===e||e.setConnected(!1)}render(){return U}}X.finalized=!0,X._$litElement$=!0,null===(J=globalThis.litElementHydrateSupport)||void 0===J||J.call(globalThis,{LitElement:X});const ee=globalThis.litElementPolyfillSupport;null==ee||ee({LitElement:X});(null!==(Y=globalThis.litElementVersions)&&void 0!==Y?Y:globalThis.litElementVersions=[]).push("3.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class se extends oe{}se.directiveName="unsafeSVG",se.resultType=2;const le=ae(se),de=ae(class extends re{constructor(e){var t;if(super(e),e.type!==te||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];null!=a&&(this.ct.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return U}});var ce=__webpack_require__(6274),he=__webpack_require__(3029),fe=__webpack_require__.n(he);const be=r(ce.Z);function ue(e){return[be,e]}const pe=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,me="1.7.14";function ge(e){" "==e.key&&(e.preventDefault(),e.target.click())}class ve extends X{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
    :host {
    ...
    `}render(){if(!this.svg)return P``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),P`<svg style="${de(e)}"><g>${le(this.svg)}</g></svg>`}}customElements.define("fa-icon",ve),customElements.define("wr-anim-logo",class extends ve{constructor(){super(),this.svg=fe()}static get styles(){return o`
    #wrlogo #stop5687 {
        ...
        <div class="navbar-start">
          ${pe?P`
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Back" @click="${()=>window.history.back()}" @keyup="${ge}">
              <fa-icon size="1.0rem" .svg="${_e()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Back</span>
            </a>
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${()=>window.history.forward()}" @keyup="${ge}">
              <fa-icon size="1.0rem" .svg="${Se()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Forward</span>
            </a>
          `:""}
        </div>
        ${this.embed?P``:P`
    ...
    <p id="skip-main-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderNavEnd(){return P`
      ...
      <fa-icon .svg="${ke()}" aria-hidden="true"></fa-icon><span>&nbsp;User Docs</span>
    </a>
    <!--
    ...
    </wr-coll-index>`}render(){return this.inited?this.embed&&this.swErrorMsg?this.swErrorMsg:P`
  ...
  `)}render(){return P`
      ...
      <div class="panel">
        ...
        ${this.renderSearchHeader()}
          <div class="control has-icons-left has-addons">
            ...
            <span class="icon is-left is-small"><fa-icon .svg="${Ne()}"/></span>
          </div>
          <wr-sorter id="index"
          sortKey="ctime"
          ?sortDesc="${!0}"
    ...
    `}renderCollInfo(e){return P`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return P`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Ge extends X{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return ue(Ge.compStyles)}static get compStyles(){return o`
    .columns {
      width: 100%;
    }
    .column {
  ...
  <div class="column is-4">
    ...
    <a @click="${t=>this.onCopy(t,e.sourceUrl)}" class="copy"><fa-icon .svg="${Me()}"/></a>
  ...
  `}renderSummaryView(){const e=this.coll;return P`
    <div class="columns">
      ...
      ${this.renderSource(e)}
    </div>`}renderDetailed(){const e=this.coll;let{numValid:t,numInvalid:i,domain:a,certFingerprint:r,datapackageHash:o,software:n}=this.coll.verify||{};t=t||0,i=i||0;const s=r?`https://crt.sh/?q=${r}`:"";return P`
      <div class="columns">
        <div class="column col-title is-4">
          <span class="subtitle has-text-weight-bold">
            ${e.title||e.filename}
    ...
    .embed-globe {
      ...
      border-style: solid;
      line-height: 0.5em;
    }`}render(){let{numValid:e,numInvalid:t,domain:i,certFingerprint:a,datapackageHash:r,publicKey:o,software:n}=this.collInfo.verify||{};e=e||0,t=t||0;const s=this.collInfo.sourceUrl,l=a?`https://crt.sh/?q=${a}`:"",d=Ke(this.ts).toLocaleString();return P`
    ...
    ${Vt.replayBarStyles}`}static get replayBarStyles(){return o`
    .breadbar {
      display: flex;
      align-items: center;
      height: 35px;
    ...
    `}render(){if(!this.inited)return P``;const e=!!this.tabData.url,t=e&&this.showSidebar;if(!e&&this.tabData&&this.tabData.view){const e={title:this.tabLabels[this.tabData.view],replayTitle:!1};this.dispatchEvent(new CustomEvent("update-title",{bubbles:!0,composed:!0,detail:e}))}return this.collInfo&&!this.collInfo.coll?P`
      ...
      </nav>`}renderLocationBar(){if("replayonly"===this.embed||"replay-with-info"==this.embed)return"";const e=Ke(this.ts).toLocaleString(),t=!!this.tabData.url,i=t&&this.favIconUrl;return P`
    ...
    <nav class="replay-bar" aria-label="replay">
      <div class="field has-addons">
        ...
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoBack}" @keyup="${ge}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${_e()}"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoForward}" @keyup="${ge}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Se()}"></fa-icon>
          </span>
        </a>
    ...
    ${Ti.sidebarStyles(r(":host(.sidebar)"))}
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?ne(Li(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return P`
    ...
    `))}`}renderCPage(e){const t=new Date(e.ts),i=Ze(t.toISOString());return P`
    <li>
      <div class="content">
    ...
    <span class="icon"><fa-icon .svg="${Ui()}"></fa-icon></span>
    ...
    `}renderContent(){switch(this.state){case"googledrive":return P`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return P`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?P`
              <div class="loaded-prog">Loaded <b>${Re()(this.currentSize)}</b> of <b>${Re()(this.totalSize)}</b>
              ${this.extraMsg&&P`
    ...
    <div class="search-bar notification is-marginless">
      ...
      <div class="field flex-auto">
        <div class="control has-icons-left ${this.loading?"is-loading":""}">
          ...
          <span class="icon is-left"><fa-icon .svg="${Ne()}" aria-hidden="true"></fa-icon></span>
        </div>
      </div>
    </div>
    <div class="main columns">
      <div class="column index-bar is-one-fifth is-hidden-mobile">
        ...
        ${this.editable?P`<fa-icon class="editIcon" .svg="${Ni()}"></fa-icon>`:P``}
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.toDeletePages=this.toDeletePage=null}" title="Confirm Delete">
      ...
      (Size: <b>${Re()(this.toDeletePage.size)}</b>)</p>`:P`
    ...
    </wr-modal>`:P``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=Ze(e.date):"string"==typeof e.ts&&(t=Ze(e.ts)),t===this.ts}return!1}renderPages(){return P`
        ...
        <div class="media">
          ...
          <div class="media-content ${this.isCurrent?"current":""}">
            <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
              <a @dblclick="${this.onReload}" @click="${this.onReplay}" href="${Qe("pages",this.page.url,this.page.timestamp)}">
        ...
        <div class="level-item flex-auto">
          ...
          <div class="field flex-auto">
            <div class="control has-icons-left ${this.loading?"is-loading":""}">
              ...
              <span class="icon is-left"><fa-icon .svg="${Ne()}"/></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      ...
      ${this.sortedResults.length?this.sortedResults.map((e=>P`
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="${Qe("resources",e.url,e.ts)}">
    ...
    `)}render(){return P`
    ${this.paramString&&this.hashString&&this.inited?P`
      <iframe sandbox="${(e=>null!=e?e:R)(this.sandbox?"allow-downloads allow-modals allow-orientation-lock allow-pointer-lock         allow-popups allow-popups-to-escape-sandbox allow-presentation allow-scripts         allow-same-origin allow-forms":void 0)}"

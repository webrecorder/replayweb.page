...
class se extends oe{}se.directiveName="unsafeSVG",se.resultType=2;const le=ae(se),ce=ae(class extends re{constructor(e){var t;if(super(e),e.type!==te||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];null!=a&&(this.ct.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return U}});var de=__webpack_require__(6274),he=__webpack_require__(3029),fe=__webpack_require__.n(he);const be=r(de.Z);function ue(e){return[be,e]}const pe=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,me="1.6.1";function ge(e){" "==e.key&&(e.preventDefault(),e.target.click())}class ve extends X{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
        ...
        <div class="navbar-start">
          ${pe?P`
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Back" @click="${()=>window.history.back()}" @keyup="${ge}">
              <fa-icon size="1.0rem" .svg="${Pe()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Back</span>
            </a>
    ...
    <p id="skip-main-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderNavEnd(){return P`
      ...
      <fa-icon .svg="${Ie()}" aria-hidden="true"></fa-icon><span>&nbsp;User Docs</span>
    </a>
    <!--
  ...
  `)}render(){return P`
    ...
    `}renderCollInfo(e){return P`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return P`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Ye extends X{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return ue(Ye.compStyles)}static get compStyles(){return o`
    .columns {
      width: 100%;
    }
    .column {
    ...
    ${Ht.replayBarStyles}`}static get replayBarStyles(){return o`
    .breadbar {
      display: flex;
      align-items: center;
      height: 35px;
    ...
    <nav class="replay-bar" aria-label="replay">
      <div class="field has-addons">
        ...
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoBack}" @keyup="${ge}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Pe()}"></fa-icon>
          </span>
        </a>
  ...
  `}renderLists(){return P`
    ...
    `))}`}renderCPage(e){const t=new Date(e.ts),i=Ce(t.toISOString());return P`
    <li>
      <div class="content">
    ...
    <div class="main columns">
      <div class="column index-bar is-one-fifth is-hidden-mobile">
        ...
        ${this.editable?P`<fa-icon class="editIcon" .svg="${Ri()}"></fa-icon>`:P``}
    ...
    </wr-modal>`:P``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=Ce(e.date):"string"==typeof e.ts&&(t=Ce(e.ts)),t===this.ts}return!1}renderPages(){return P`

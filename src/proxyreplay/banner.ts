...
export class WBBanner extends LitElement {
  ...
  render() {
    ...
    return html`
      ...
      >
        <div class="rounded-xl bg-cyan-50 flex gap-4 items-center">
          <a
          ...
          <details class="group flex gap-1 text-sm">
            <summary
              class="cursor-pointer summary-reset m-0 py-1 text-cyan-700 text-balance flex items-center gap-2 select-none"
              title="Archive Details"
            >
              <span>
                You are viewing an archived version of this page from
                <span class="font-bold text-cyan-800">${dateStr}</span></span
              >
              <span
        ...
        <button
          class="cursor pointer rounded-xl bg-cyan-50 flex p-2 items-center"
          id="refresh"
          ...
          <div>
            <h2>
              ...
              <a href="https://webrecorder.net/browsertrix" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-[1.6cap] inline color-black w-auto ml-1 align-[-0.27em]"
                  viewBox="0 0 649 96"
                >

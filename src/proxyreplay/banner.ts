...
import { withGlobalStyles } from "./app";
...
export class WBBanner extends LitElement {
  ...
  render() {
    ...
    return html`
      ...
      >
        <div
          class="rounded-xl bg-lime-50 has-[summary:hover]:bg-lime-100 has-[summary:hover]:ring-1 ring-lime-500 transition-colors flex gap-4 items-center"
        >
          <a
          ...
          <details class="group/details flex gap-1 text-sm">
            <summary
              class="group/summary cursor-pointer summary-reset m-0 py-1 text-lime-600 hover:text-lime-800 text-balance flex items-center gap-2 select-none"
              title="Archive Details"
            >
              <span>
                You are viewing an archived version of this page from
                <span
                  class="font-bold text-lime-800 group-hover/summary:text-lime-900"
                  >${dateStr}</span
                ></span
              >
              <span
                class="size-4 inline-block mr-2 in-open:rotate-180 transition-transform"
                aria-hidden="true"
            ...
            <h2>
              ...
              <a href="https://webrecorder.net" target="_blank"
                ...
                ><svg
                  ...
                  class="h-[1cap] inline-block w-auto ml-1 align-[0]"
                  viewBox="0 0 1142 96"
                >

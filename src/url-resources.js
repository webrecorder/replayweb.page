      ...
      <div class="notification level is-marginless">
        <div class="level-left flex-auto">
          <div class="level-item flex-auto">
            <span role="heading" aria-level="2">Search:&nbsp;&nbsp;</span>
            <div class="select">
            ...
            <div class="field flex-auto">
              <div class="control has-icons-left ${this.loading ? 'is-loading' : ''}">
                <input type="text" class="input" @input="${this.onChangeQuery}" .value="${this.query}" type="text" aria-label="Enter URL to Search" placeholder="Enter URL to Search">

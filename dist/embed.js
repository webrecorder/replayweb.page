 ...
 * http://polymer.github.io/PATENTS.txt
 */
const n=new WeakMap,r=t=>(...e)=>{const s=t(...e);return n.set(s,!0),s},i=t=>"function"==typeof t&&n.has(t)},109:function(t,e,s){"use strict";s.r(e);var n=s(0);class r extends n.a{constructor(){super(),this.replayBase="http://localhost:9990/",this.view="replay",this.ts="",this.url="",this.config="",this.coll="",this.paramString=null}static get properties(){return{url:{type:String},ts:{type:String},source:{type:String},replayBase:{type:String},title:{type:String},coll:{type:String},config:{type:String},paramString:{type:String},hashString:{type:String}}}firstUpdated(){window.addEventListener("message",t=>{const e=this.renderRoot.querySelector("iframe");e&&t.source===e.contentWindow&&t.data.title&&(this.title=t.data.title)})}updated(t){(t.has("url")||t.has("ts")||t.has("source"))&&(this.paramString=new URLSearchParams({source:this.source,customColl:this.coll,config:this.config,embed:"true"}).toString(),this.hashString=new URLSearchParams({url:this.url,ts:this.ts,view:this.view}).toString())}static get styles(){return n.b`
      iframe {
        width: 100%;
        height: 100%;
        border: 0px;
    ...
    ${this.paramString&&this.hashString?n.c`
      ...
      `:n.c``}
    `}}!async function(){customElements.define("replay-web-page",r)}()},13:function(t,e,s){"use strict";s.d(e,"b",(function(){return o})),s.d(e,"a",(function(){return a}));var n=s(5),r=s(1);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const r=new class{handleAttributeExpressions(t,e,s,r){const i=e[0];if("."===i){return new n.f(t,e.slice(1),s).parts}return"@"===i?[new n.d(t,e.slice(1),r.eventContext)]:"?"===i?[new n.c(t,e.slice(1),s)]:new n.a(t,e,s).parts}handleTextExpression(t){return new n.e(t)}};var i=s(13),o=s(10);s(5),s(4),s(9),s(8),s(14),s(1);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
